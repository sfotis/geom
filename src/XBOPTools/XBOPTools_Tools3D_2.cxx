...
//purpose  : 
//=======================================================================
  Standard_Boolean XBOPTools_Tools3D::TreatedAsAnalytic(const TopoDS_Face& aFx, 
...
{ 
  ...
  //
  bIsAnalytic=XBOPTools_Tools3D::HasAnalyticSurfaceType(aFx);
  if (!bIsAnalytic) {
    return bFlag;
  }
  bIsAnalytic=XBOPTools_Tools3D::HasAnalyticSurfaceType(aF1);
  if (!bIsAnalytic) {
    return bFlag;
  }
  //
  Handle(Geom_Curve)aC3D =BRep_Tool::Curve(aSpE1, aTb, aTe);
  aT1=XBOPTools_Tools2D::IntermediatePoint (aTb, aTe);
  aC3D->D0(aT1, aP1);
  //
  XBOPTools_Tools3D::GetNormalToFaceOnEdge(aSpE1, aF1, aT1, aDNS1);
  XBOPTools_Tools3D::GetNormalToFaceOnEdge(aSpE1, aFx, aT1, aDNSx);
  //
  bIsDirsCoinside=XIntTools_Tools::IsDirsCoinside(aDNSx, aDNS1, aTolTangent);
  if (!bIsDirsCoinside) {
    return bFlag;
  }
  //
...
//purpose  : 
//=======================================================================
  Standard_Boolean XBOPTools_Tools3D::TreatedAsAnalytic(const Standard_Real aTx,
						       const gp_Pnt& aPx,
...
{ 
  ...
  //
  XBOPTools_Tools3D::GetNormalToFaceOnEdge(anEx, aFx, aTx, aDNSx);
  aContext->ProjectPointOnEdge(aPx, anE1, aT1);
  XBOPTools_Tools3D::GetNormalToFaceOnEdge(anE1, aF1, aT1, aDNS1);
  //
  bIsDirsCoinside=XIntTools_Tools::IsDirsCoinside(aDNSx, aDNS1, aTolTangent);
  if (!bIsDirsCoinside) {
    return bFlag;
...
//purpose  : 
//=======================================================================
  Standard_Boolean XBOPTools_Tools3D::HasAnalyticSurfaceType(const TopoDS_Face& aF)
{
