...
//purpose  : 
//=======================================================================
  Standard_Boolean XBOPTools_Tools2D::EdgeTangent(const TopoDS_Edge& anEdge, 
...
//purpose  : 
//=======================================================================
  void XBOPTools_Tools2D::FaceNormal (const TopoDS_Face& aF,
...
//purpose  : 
//=======================================================================
  void XBOPTools_Tools2D::RemovePCurveForEdgeOnFace (const TopoDS_Edge& aE,
...
//purpose  : 
//=======================================================================
  void XBOPTools_Tools2D::BuildPCurveForEdgeOnFace (const TopoDS_Edge& aE,
						   const TopoDS_Face& aF)
{
  BRep_Builder aBB;
  Handle(Geom2d_Curve) aC2D;
  ...
  aHasOld=XBOPTools_Tools2D::HasCurveOnSurface (aE, aF, aC2D, aFirst, aLast, aTolEdge);
  if (aHasOld) {
    return;
  }
  

  XBOPTools_Tools2D::CurveOnSurface(aE, aF, aC2D, aTolPC, Standard_True);
...
//purpose  : 
//=======================================================================
  void XBOPTools_Tools2D::PointOnSurface (const TopoDS_Edge& aE,
					 const TopoDS_Face& aF,
					 ...
					 Standard_Real& V)
{
  ...
  XBOPTools_Tools2D::CurveOnSurface (aE, aF, aC2D, aFirst, aLast, aToler, Standard_True); 
...
//purpose  : 
//=======================================================================
  void XBOPTools_Tools2D::CurveOnSurface (const TopoDS_Edge& aE,
					 const TopoDS_Face& aF,
					 Handle(Geom2d_Curve)& aC2D,
					 ...
					 const Standard_Boolean trim3d)
{
  ...
  XBOPTools_Tools2D::CurveOnSurface (aE, aF, aC2D, aFirst, aLast, aToler, trim3d); 
					 ...
					 const Standard_Boolean trim3d)
{
  ...
  aHasOld=XBOPTools_Tools2D::HasCurveOnSurface (aE, aF, C2D, aFirst, aLast, aToler);
  if (aHasOld) {
    aC2D=C2D;
    return;
  }

  XBOPTools_Tools2D::Make2D(aE, aF, C2D, aFirst, aLast, aToler, trim3d);
  aC2D=C2D;
  return;
}
...
//purpose  : 
//=======================================================================
  Standard_Boolean XBOPTools_Tools2D::HasCurveOnSurface (const TopoDS_Edge& aE,
							const TopoDS_Face& aF,
							Handle(Geom2d_Curve)& aC2D,
							Standard_Real& aFirst,
							Standard_Real& aLast,
...
//purpose  : 
//=======================================================================
  void XBOPTools_Tools2D::MakeCurveOnSurface (const TopoDS_Edge& aE,
					     const TopoDS_Face& aF,
					     Handle(Geom2d_Curve)& aC2D,
					     Standard_Real& aFirst,
					     Standard_Real& aLast,
					     ...
					     const Standard_Boolean trim3d)
{
  XBOPTools_Tools2D::Make2D(aE, aF, aC2D, aFirst, aLast, aToler, trim3d);
}
...
//purpose  : 
//=======================================================================
  void XBOPTools_Tools2D::Make2D (const TopoDS_Edge& aE,
				 const TopoDS_Face& aF,
				 Handle(Geom2d_Curve)& aC2D,
				 Standard_Real& aFirst,
				 Standard_Real& aLast,
				 ...
				 const Standard_Boolean trim3d)
{
  ...
  XBOPTools_Tools2D::MakePCurveOnFace(aF, C3D3, f3d, l3d, aC2D, aToler);
  //
  aFirst = f3d; 
  aLast  = l3d;
}
...
//purpose  : 
//=======================================================================
  void XBOPTools_Tools2D::MakePCurveOnFace (const TopoDS_Face& aF,
					   ...
					   Standard_Real& TolReached2d)
{
  ...
  TolReached2d=0.;
  //
  XBOPTools_Tools2D::MakePCurveOnFace (aF, aC3D, aFirst, aLast, aC2D, TolReached2d);
}
...
//purpose  : 
//=======================================================================
  void XBOPTools_Tools2D::AdjustPCurveOnFace (const TopoDS_Face& aF,
					     const Handle(Geom_Curve)&   aC3D,
					     ...
					     Handle(Geom2d_Curve)& aC2DA)
{
  ...
  XBOPTools_Tools2D::AdjustPCurveOnFace (aF, first, last, aC2D, aC2DA);
} 
//=======================================================================
//function : AdjustPCurveOnFace
//purpose  : 
...
//purpose  : 
//=======================================================================
  void  XBOPTools_Tools2D::MakePCurveOfType(const ProjLib_ProjectedCurve& PC, 
					   Handle(Geom2d_Curve)& C2D)
{
  ...
  case GeomAbs_OtherCurve : 
    default :
    Standard_NotImplemented::Raise("XBOPTools_Tools2D::MakePCurveOfType");
    break;
  }
}
...
//purpose  : 
//=======================================================================
  Standard_Boolean XBOPTools_Tools2D::TangentOnEdge(const Standard_Real par, 
						   const TopoDS_Edge& E, 
						   gp_Vec& Tg)
{
  Standard_Boolean isdgE;
...
//purpose  : 
//=======================================================================
  Standard_Boolean XBOPTools_Tools2D::TangentOnEdge(const TopoDS_Edge& aE, 
						   gp_Dir& DTg)
{
  Standard_Real aT;
  gp_Vec aTg;
  ...
  Standard_Boolean bIsFound=XBOPTools_Tools2D::TangentOnEdge(aT, aE, aTg);
  if (bIsFound) {
    gp_Dir aDTmp(aTg);
    DTg=aDTmp;
  }
...
//purpose  : 
//=======================================================================
  Standard_Boolean XBOPTools_Tools2D::TangentOnVertex (const TopoDS_Vertex& v, 
...
// vl : last vertex of e
{
  ...
  ok =XBOPTools_Tools2D::TangentOnEdge (par, e, tg);
  if (!ok) {
    return ok;
  }
  if (v.IsSame(vl)) {
...
//purpose  : 
//=======================================================================
  void XBOPTools_Tools2D::EdgeBounds (const TopoDS_Edge& aE,
				     Standard_Real& aFirst,
				     Standard_Real& aLast)
{
...
//purpose  : 
//=======================================================================
  Standard_Real XBOPTools_Tools2D::IntermediatePoint (const Standard_Real aFirst,
						     const Standard_Real aLast)
{
...
//purpose  : 
//=======================================================================
  Standard_Real XBOPTools_Tools2D::IntermediatePoint (const TopoDS_Edge& aE)
