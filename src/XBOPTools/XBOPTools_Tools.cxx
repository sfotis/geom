...
// purpose: 
//=======================================================================
  Standard_Boolean XBOPTools_Tools::IsBlockInOnFace (const XBOPTools_PaveBlock& aPB1,
						    ...
						    const Handle(XIntTools_Context)& aContext)
{
  ...
  //
  // Edge's data 
  const XIntTools_ShrunkRange& aSR1=aPB1.ShrunkRange();
  const TopoDS_Edge& aE1=aSR1.Edge();
 
  const XIntTools_Range& aShrR= aSR1.ShrunkRange();
  aShrR.Range(f1, l1);
  //
  ...
  //
  // Treatment P11
  XBOPTools_Tools::PointOnEdge(aE1, f1, aP11);
  //
  ...
  //
  // Treatment P12
  XBOPTools_Tools::PointOnEdge(aE1, l1, aP12);
  //
  ...
  m1=XIntTools_Tools::IntermediatePoint(f1, l1);
  XBOPTools_Tools::PointOnEdge(aE1, m1, aP12);
  //
  aProjector.Perform(aP12);
  //
  bFlag=aProjector.IsDone();
...
// purpose: 
//=======================================================================
  Standard_Boolean XBOPTools_Tools::IsBlocksCoinside(const XBOPTools_PaveBlock& aPB1,
						    const XBOPTools_PaveBlock& aPB2)
{
  ...
  const XIntTools_ShrunkRange aSR2=aPB2.ShrunkRange();
  const TopoDS_Edge& aE2=aSR2.Edge();
  aTol2=BRep_Tool::Tolerance(aE2);
  aPB2.Parameters(f2, l2);
  gp_Pnt aP21, aP22;
  XBOPTools_Tools::PointOnEdge(aE2, f2, aP21);
  XBOPTools_Tools::PointOnEdge(aE2, l2, aP22);
  ////
...
// purpose: 
//=======================================================================
  void XBOPTools_Tools::UpdateVertex (const TopoDS_Vertex& aVF,
...
// purpose: 
//=======================================================================
  void XBOPTools_Tools::UpdateVertex (const TopoDS_Edge& aE,
...
// purpose: 
//=======================================================================
  void XBOPTools_Tools::UpdateVertex (const XIntTools_Curve& aC,
				     const Standard_Real  aT,
				     const TopoDS_Vertex& aV)
{
...
// purpose: 
//=======================================================================
  void XBOPTools_Tools::MakeSectEdge(const XIntTools_Curve& aIC,
...
// purpose: 
//=======================================================================
  void XBOPTools_Tools::MakeSplitEdge(const TopoDS_Edge&   aE,
				     const TopoDS_Vertex& aV1,
				     const Standard_Real  aP1,
				     const TopoDS_Vertex& aV2,
				     const Standard_Real  aP2,
...
// purpose: 
//=======================================================================
  void XBOPTools_Tools::MakeNewVertex(const TopoDS_Vertex& aV1,
				     const TopoDS_Vertex& aV2,
...
// purpose: 
//=======================================================================
  void XBOPTools_Tools::MakeNewVertex(const gp_Pnt& aP,
...
// purpose: 
//=======================================================================
  void XBOPTools_Tools::MakeNewVertex(const TopoDS_Edge& aE1,
...
// purpose: 
//=======================================================================
  void XBOPTools_Tools::PointOnEdge(const TopoDS_Edge& aE,
...
//purpose  : 
//=======================================================================
  void XBOPTools_Tools::CopySource(const TopoDS_Shape& aSS, 
				  TopoDS_Shape& aSD)
{
  TopTools_IndexedDataMapOfShapeShape aMapSS;
...
//purpose  : 
//=======================================================================
  void XBOPTools_Tools::MapShapes(const TopoDS_Shape& aS,
				 TopTools_IndexedMapOfShape& aM)
{
  ...
  for (; anIt.More(); anIt.Next()) {
    ...
    XBOPTools_Tools::MapShapes(aSx, aM);
  }
}
...
//purpose  : 
//=======================================================================
  void XBOPTools_Tools::CorrectRange(const TopoDS_Edge& aE1,
				    const TopoDS_Edge& aE2,
				    const XIntTools_Range& aSR,
				    XIntTools_Range& aNewSR)
{
  Standard_Integer i;
...
//purpose  : 
//=======================================================================
  void XBOPTools_Tools::CorrectRange(const TopoDS_Edge& aE,
				    const TopoDS_Face& aF,
				    const XIntTools_Range& aSR,
				    XIntTools_Range& aNewSR)
{
