...
#include <XBOPTools_DSFiller.ixx>
...
//=======================================================================
// function: XBOPTools_PoolsFiller
// purpose: 
//=======================================================================
  XBOPTools_DSFiller::XBOPTools_DSFiller() 
{
  myPaveFiller=NULL;
  myInterfPool=NULL;
  myDS=NULL;
...
// purpose: 
//=======================================================================
  void XBOPTools_DSFiller::Perform()
{
  myIsDone=Standard_False;
  ...
  myNewFiller=Standard_True;
  //
  myDS        = new XBooleanOperations_ShapesDataStructure (myShape1, myShape2);
  myInterfPool= new XBOPTools_InterferencePool (*myDS);
  //
  // Build Vertices, Paves, splits, 
  myPaveFiller = new XBOPTools_PaveFiller(*myInterfPool);
...
// purpose: 
//=======================================================================
  void XBOPTools_DSFiller::InitFillersAndPools()
{
  myIsDone=Standard_False;
...
// purpose: 
//=======================================================================
  void XBOPTools_DSFiller::PartialPerform(const TColStd_SetOfInteger& anObjSubSet,
...
// purpose: 
//=======================================================================
  void XBOPTools_DSFiller::ToCompletePerform()
{
  if(myIsDone) {
    myIsDone=Standard_False;
    //
...
// purpose:
//=======================================================================
  void XBOPTools_DSFiller::Perform(const XBOPTools_SSIntersectionAttribute& theSectionAttribute) 
{
  myIsDone=Standard_False;
  ...
  //
  // Build Vertices, Paves, splits, 
  myPaveFiller = new XBOPTools_PaveFiller(*myInterfPool, theSectionAttribute);
  myPaveFiller->Perform();
  myIsDone=myPaveFiller->IsDone();
}
...
// purpose:
//=======================================================================
  void XBOPTools_DSFiller::Destroy() 
{
  Clear();
}
...
// purpose: 
//=======================================================================
  void XBOPTools_DSFiller::SetShapes (const TopoDS_Shape& aS1,
...
// purpose: 
//=======================================================================
  const TopoDS_Shape& XBOPTools_DSFiller::Shape1 () const 
{
  return myShape1;
}
...
// purpose: 
//=======================================================================
  const TopoDS_Shape& XBOPTools_DSFiller::Shape2 () const 
{
  return myShape2;
}
//=======================================================================
...
// purpose: 
//=======================================================================
  const XBooleanOperations_ShapesDataStructure& XBOPTools_DSFiller::DS () const 
{
  return *myDS;
}
//=======================================================================
...
// purpose: 
//=======================================================================
  const XBOPTools_InterferencePool& XBOPTools_DSFiller::InterfPool () const
{
  return *myInterfPool;
}
//=======================================================================
...
// purpose: 
//=======================================================================
  const XBOPTools_PavePool& XBOPTools_DSFiller::PavePool () const 
{
...
// purpose: 
//=======================================================================
  const XBOPTools_CommonBlockPool& XBOPTools_DSFiller::CommonBlockPool () const 
{
...
// purpose: 
//=======================================================================
  const XBOPTools_SplitShapesPool& XBOPTools_DSFiller::SplitShapesPool() const
{
...
// purpose: 
//=======================================================================
  const XBOPTools_PaveFiller& XBOPTools_DSFiller::PaveFiller() const
{
  return *myPaveFiller;
}
...
// purpose: 
//=======================================================================
  Standard_Boolean XBOPTools_DSFiller::IsNewFiller() const
{
  return myNewFiller;
}
...
// purpose: 
//=======================================================================
  void XBOPTools_DSFiller::SetNewFiller(const Standard_Boolean aFlag) const
{
  XBOPTools_DSFiller* pDSFiller=(XBOPTools_DSFiller*)this;
...
// purpose: 
//=======================================================================
  Standard_Boolean XBOPTools_DSFiller::IsDone()const 
{
  return myIsDone;
}
//
...
// Standard_Integer TreatCompound(const TopoDS_Shape& aS,
// 			       TopoDS_Shape& aShapeResult)
Standard_Integer XBOPTools_DSFiller::TreatCompound(const TopoDS_Shape& aS,
						  TopoDS_Shape&       aShapeResult) 
{
  //
