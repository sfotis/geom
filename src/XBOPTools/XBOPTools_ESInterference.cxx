...
#include <XBOPTools_ESInterference.ixx>

//=======================================================================
//function :  XBOPTools_ESInterference
//purpose  : 
//=======================================================================
XBOPTools_ESInterference::XBOPTools_ESInterference()
:
...
//purpose  : 
//=======================================================================
  const XIntTools_CommonPrt& XBOPTools_ESInterference::CommonPrt() const 
{
  return myCommonPart;
}
