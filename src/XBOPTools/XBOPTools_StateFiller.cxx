...
#include <XBOPTools_StateFiller.ixx>
...
//=======================================================================
// function:  XBOPTools_StateFiller::XBOPTools_StateFiller
// purpose: 
//=======================================================================
XBOPTools_StateFiller::XBOPTools_StateFiller(const XBOPTools_PaveFiller& aFiller)
:
...
// purpose: 
//=======================================================================
  Standard_Boolean XBOPTools_StateFiller::IsDone() const
{
  return myIsDone;
}
...
// purpose: 
//=======================================================================
  XBooleanOperations_StateOfShape XBOPTools_StateFiller::ConvertState(const TopAbs_State aSt)
{
...
// purpose: 
//=======================================================================
  TopAbs_State XBOPTools_StateFiller::ConvertState(const XBooleanOperations_StateOfShape aSt)
{
  TopAbs_State aState;
...
// purpose: 
//=======================================================================
  XBooleanOperations_StateOfShape XBOPTools_StateFiller::ClassifyShapeByRef (const TopoDS_Shape& aS,
...
//  Modified by skv - Tue Aug 24 12:31:16 2004 OCC6450 Begin
	...
	aParU = XIntTools_Tools::IntermediatePoint(aUMin, aUMax);
      }
	...
	aParV = XIntTools_Tools::IntermediatePoint(aVMin, aVMax);
      }
...
//  Modified by skv - Tue Aug 24 12:31:16 2004 OCC6450 Begin
  ...
  XBooleanOperations_StateOfShape aState=XBOPTools_StateFiller::ConvertState(aSt) ;
...
// purpose: 
//=======================================================================
  TopAbs_State  XBOPTools_StateFiller::ClassifyEdgeToSolidByOnePoint(const TopoDS_Edge& E,
...
// purpose: 
//=======================================================================
  TopAbs_ShapeEnum XBOPTools_StateFiller::SubType(const TopoDS_Shape& aS)
{
