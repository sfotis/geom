...
#include <XBOPTools_SolidStateFiller.ixx>
...
//=======================================================================
// function: XBOPTools_SolidStateFiller::XBOPTools_SolidStateFiller
// purpose: 
//=======================================================================
  XBOPTools_SolidStateFiller::XBOPTools_SolidStateFiller(const XBOPTools_PaveFiller& aFiller)
:
...
// purpose: 
//=======================================================================
  void XBOPTools_SolidStateFiller::Do()
{
...
// purpose: 
//=======================================================================
  void XBOPTools_SolidStateFiller::DoNonSections(const Standard_Integer iRankObj)
{
  //
  ...
  for (i=1; i<=aNb; i++) {
    ...
    const XBOPTools_ListOfPaveBlock& aSplitEdges=aSplitShapesPool(myDS->RefEdge(nE));
    ...
    //
    if (aNbPaveBlocks==1) {
      const XBOPTools_ListOfCommonBlock& aCBlocks=aCommonBlockPool(myDS->RefEdge(nE));
      if (!aCBlocks.Extent()) {
	const XBOPTools_PaveBlock& aPB=aSplitEdges.First();
...
// purpose: 
//=======================================================================
  void XBOPTools_SolidStateFiller::DoShellNonSections(const Standard_Integer iRankObj)
{
  ...
  //
  // 1.1. Check EF FF interferences with nF 
  const XBOPTools_CArray1OfSSInterference& aFFs=myIntrPool->SSInterferences();
  
  aNb=aFFs.Extent();
  for (i=1; i<=aNb; i++) {
    const XBOPTools_SSInterference& aFF=aFFs(i);
    // nF1
    nF1=aFF.Index1();
    nF2=aFF.Index2();
...
// purpose: 
//=======================================================================
  void XBOPTools_SolidStateFiller::DoSections()
{
  ...
  for (i=1; i<=aNb; i++) {
	...
	nE=aPB.Edge();
	myDS->SetState(nE, XBooleanOperations_ON);
      }
    }
  } 
}
...
// purpose: 
//=======================================================================
  Standard_Boolean XBOPTools_SolidStateFiller::IsFaceIntersected(const Standard_Integer nF) 
{
  Standard_Boolean bFlag=Standard_False;
  Standard_Integer i, aNb, n1, n2;
  
  const XBOPTools_CArray1OfESInterference& aEFs=myIntrPool->ESInterferences();
  aNb=aEFs.Extent();
  for (i=1; i<=aNb; i++) {
...
XBooleanOperations_StateOfShape 
    XBOPTools_SolidStateFiller::ConvertState(const TopAbs_State aSt)
{
  XBooleanOperations_StateOfShape aState;
  switch (aSt) {
    case TopAbs_IN:
...
//=======================================================================
TopAbs_State 
    XBOPTools_SolidStateFiller::ConvertState(const XBooleanOperations_StateOfShape aSt)
{
  TopAbs_State aState;
...
//=======================================================================
  XBooleanOperations_StateOfShape 
    XBOPTools_SolidStateFiller::ClassifyShapeByRef (const TopoDS_Shape& aS,
						   const TopoDS_Shape& aRef)
{
  ...
  TopAbs_State aSt=XBOPTools_SolidStateFiller::ClassifyEdgeToSolidByOnePoint(aE, aRef);
  XBooleanOperations_StateOfShape aState=XBOPTools_SolidStateFiller::ConvertState(aSt) ;
...
//=======================================================================
TopAbs_State 
  XBOPTools_SolidStateFiller::ClassifyEdgeToSolidByOnePoint(const TopoDS_Edge& E,
							   const TopoDS_Shape& Ref)
{
  ...
  if(C3D.IsNull()) {
    ...
    par=XIntTools_Tools::IntermediatePoint(f2, l2);
    C3D -> D0(par, aP3d);
  }
...
// purpose: 
//=======================================================================
  TopAbs_ShapeEnum XBOPTools_SolidStateFiller::SubType(const TopoDS_Shape& aS)
{
