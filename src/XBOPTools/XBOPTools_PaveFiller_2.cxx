...
//=======================================================================
Standard_Integer XBOPTools_PaveFiller::SplitsInFace(const Standard_Integer ,//for overriding
...
//=======================================================================
  Standard_Integer XBOPTools_PaveFiller::SplitsInFace(const Standard_Integer nE1,
						     const Standard_Integer nF2,
						     TColStd_ListOfInteger& aSplits)
{
  ...
  const XBOPTools_ListOfCommonBlock& aLCB=myCommonBlockPool(myDS->RefEdge(nE1));
...
//=======================================================================
  Standard_Integer XBOPTools_PaveFiller::SplitsOnEdge(const Standard_Integer nE1,
...
//=======================================================================
  Standard_Integer XBOPTools_PaveFiller::SplitsOnFace(const Standard_Integer nE1,
						     const Standard_Integer nF2,
						     TColStd_ListOfInteger& aSplits)
{
...
//=======================================================================
  Standard_Integer XBOPTools_PaveFiller::SplitsOnFace(const Standard_Integer ,//for overriding
						     const Standard_Integer nF1,
						     const Standard_Integer nF2,
						     TColStd_ListOfInteger& aSplits)
{
						     ...
						     XBOPTools_ListOfPaveBlock& aLPB)
{
  ...
  for (; anItCB.More(); anItCB.Next()) {
    ...
    if (nE==nE2) {
      ...
      //aLPB.Append(aPB1);
      const XBOPTools_PaveBlock& aPB1R=aCB.PaveBlock1();
      aLPB.Append(aPB1R);
