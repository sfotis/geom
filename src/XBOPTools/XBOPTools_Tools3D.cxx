...
//purpose  : 
//=======================================================================
  void XBOPTools_Tools3D::RemoveSims (const TopoDS_Shape& aS,
				     const Handle(XIntTools_Context)& aContext)
{
  ...
  for (; anExp.More(); anExp.Next()) {
    ...
    //
    XBOPTools_Tools3D::RemoveSims (aF, aContext);
  }
}
...
//purpose  : 
//=======================================================================
  void XBOPTools_Tools3D::RemoveSims (const TopoDS_Face& aFF,
				     const Handle(XIntTools_Context)& aContext)
{
...
//purpose  : 
//=======================================================================
  Standard_Integer XBOPTools_Tools3D::SubShapesAmount (const TopoDS_Shape& aS,
...
//purpose  : 
//=======================================================================
  Standard_Boolean XBOPTools_Tools3D::IsConvexWire (const TopoDS_Wire& aW)
{
  Standard_Boolean aFlag;
  Standard_Integer aNbV, aNbE;

  aNbV=XBOPTools_Tools3D::SubShapesAmount(aW, TopAbs_VERTEX);
  aNbE=XBOPTools_Tools3D::SubShapesAmount(aW, TopAbs_EDGE);
  aFlag=aNbV <= aNbE;
  return aFlag;
}
...
//purpose  : 
//=======================================================================
  void XBOPTools_Tools3D::DoSplitSEAMOnFace (const TopoDS_Edge& aSplit,
					    const TopoDS_Face& aF)
{
  ...
  */
  ...
  //
  aT=XBOPTools_Tools2D::IntermediatePoint(a, b);
...
//purpose  : 
//=======================================================================
Standard_Boolean XBOPTools_Tools3D::DoSplitSEAMOnFace(const TopoDS_Edge& theSplit,
						     ...
						     Standard_Boolean&  IsReversed) 
{
  ...
  aT = XBOPTools_Tools2D::IntermediatePoint(f, l);
  C2D1->D1(aT, aP2D, aVec2D);
...
//purpose  : 
//=======================================================================
  Standard_Boolean XBOPTools_Tools3D::IsSplitToReverse1 (const TopoDS_Edge& aEF1,
							...
							const Handle(XIntTools_Context)& aContext)
{
  ...
  aT1=XBOPTools_Tools2D::IntermediatePoint(a, b);
  aC1->D0(aT1, aP);
  aFlag=XBOPTools_Tools2D::EdgeTangent(aEF1, aT1, aV1);
  ...
  //
  aFlag=XBOPTools_Tools2D::EdgeTangent(aEF2, aT2, aV2);
  if(!aFlag) {
    return Standard_False;
  }
...
//purpose  : 
//=======================================================================
  TopAbs_Orientation XBOPTools_Tools3D::EdgeOrientation (const TopoDS_Edge& aE,
							...
							const TopoDS_Face& aF2)
{
  ...
  XBOPTools_Tools3D::GetNormalToFaceOnEdge(aE, aF1, aDNF1);
  XBOPTools_Tools3D::GetNormalToFaceOnEdge(aE, aF2, aDNF2);
  
  aDTN=aDNF1^aDNF2;
  
  XBOPTools_Tools2D::TangentOnEdge(aE, aDTE);
...
//purpose  : 
//=======================================================================
  Standard_Boolean XBOPTools_Tools3D::IsTouchCase(const TopoDS_Edge& aE,
						 const TopoDS_Face& aF1,
						 const TopoDS_Face& aF2)
{
  gp_Dir aDNF1, aDNF2;
  ...
  bIsDirsCoinside=XIntTools_Tools::IsDirsCoinside(aDNF1, aDNF2);
...
//purpose  : 
//=======================================================================
  void XBOPTools_Tools3D::GetNormalToFaceOnEdge (const TopoDS_Edge& aE,
						const TopoDS_Face& aF,
						gp_Dir& aDNF)
{
						...
						gp_Dir& aDNF1)
{
  ...
  XBOPTools_Tools2D::CurveOnSurface(aE, aF1, aC2D1, aTolPC, Standard_True);
...
//purpose  :
//=======================================================================
  void XBOPTools_Tools3D::GetBiNormal(const TopoDS_Edge& aE,
				     const TopoDS_Face& aF,
				     const Standard_Real aT, 
				     gp_Dir& aDB)
{
  ...
  XBOPTools_Tools3D::GetTangentToEdge(aE, aT, aDT);
...
//purpose  :
//=======================================================================
  void XBOPTools_Tools3D::GetBiNormal(const TopoDS_Edge& aSp,
				     const TopoDS_Face& aF,
				     gp_Dir& aDB)
{
  gp_Dir aDNF, aDD1Sp;
  //
  // Normal to the face aF at parameter aT
  XBOPTools_Tools3D::GetNormalToFaceOnEdge (aSp, aF, aDNF);
  //
  // Split tangent on aF at parameter aT
  XBOPTools_Tools3D::GetTangentToEdge(aSp, aDD1Sp);
...
//purpose  : 
//=======================================================================
  Standard_Boolean XBOPTools_Tools3D::GetTangentToEdge(const TopoDS_Edge& anEdge, 
						      gp_Dir& aDT)
{
  ...
  XBOPTools_Tools3D::GetTangentToEdge(anEdge, aT, aDT);
...
//purpose  : 
//=======================================================================
  Standard_Boolean XBOPTools_Tools3D:: IsSplitToReverse(const TopoDS_Edge& aE,
						       const TopoDS_Edge& aSp)
{
  ...
  aT=XBOPTools_Tools2D::IntermediatePoint(t1, t2);
...
//purpose  :
//=======================================================================
  Standard_Boolean XBOPTools_Tools3D::GetAdjacentFace(const TopoDS_Face& aFaceObj,
...
//purpose  :
//=======================================================================
  Standard_Boolean XBOPTools_Tools3D::IsKeepTwice(const TopoDS_Face& aF1,
						 const TopoDS_Face& aF2,
...
//purpose  :
//=======================================================================
  Standard_Integer XBOPTools_Tools3D::SenseFlag (const gp_Dir& aDNF1,
						const gp_Dir& aDNF2)
{
  Standard_Boolean bIsDirsCoinside;
  bIsDirsCoinside=XIntTools_Tools::IsDirsCoinside(aDNF1, aDNF2);
...
//purpose  :
//=======================================================================
  Standard_Boolean XBOPTools_Tools3D::GetNormalToSurface (const Handle(Geom_Surface)& aS,
							 ...
							 gp_Dir& aDNS)
{
  ...
  bFlag=XIntTools_Tools::IsDirsCoinside(aDD1U, aDD1U);
  if (!bFlag) {
    return bFlag;
  }
					  ...
					  gp_Dir& aDNF)
{
  ...
  //gp_Pnt aPNear;
  gp_Pnt2d aPx2DNear;
  XBOPTools_Tools3D::PointNearEdge (aE, aF, aT, aDT, aPx2DNear, aPNear);
  
  Handle(Geom_Surface) aS=BRep_Tool::Surface(aF);
  
  XBOPTools_Tools3D::GetNormalToSurface (aS, aPx2DNear.X(), aPx2DNear.Y(), aDNF);
...
//purpose  :
//=======================================================================
  void XBOPTools_Tools3D::GetPlanes (const TopoDS_Edge& aSpx,
				    ...
				    const Handle(XIntTools_Context)& aContext)
{
  ...
  for (; anIt.More(); anIt.Next()) {
    ...
    anOr=XBOPTools_Tools3D::Orientation(anEx, aFx1);
    if (anOr==anOrEx){
      break;
    }
  }
  ...
  if( aMoreShift ) {
    ...
    //-- EJG
    XBOPTools_Tools3D::GetApproxNormalToFaceOnEdge (anEx, aFx1, aT, aPx1, aDNFx1);
  }

  bIsAdjExists=XBOPTools_Tools3D::GetAdjacentFace (aFx1, anEx, anEFMapx, aFx2);
  ...
  if (!bIsAdjExists) {
    ...
    if(  aMoreShift ) {
      ...
      //-- EJG
      XBOPTools_Tools3D::GetApproxNormalToFaceOnEdge (aSpxSimm, aFx1, aT, aPx2, aDNFx2); 
    }
    ...
    XBOPTools_Tools3D::GetApproxNormalToFaceOnEdge (aSpxSimm, aFx2, aT, aPx2, aDNFx2);
    //  
    aContext->ProjectPointOnEdge(aPx, anE1, aT1);
    PointNearE (anE1, aF1, aT1, aPF1, aMoreShift);
  }
  
  {
    ...
    d12=XBOPTools_Tools3D::SignDistance(aPx2, aPlnToCompare);
    if (d12 < 0.) {
    ...
    d1=XBOPTools_Tools3D::SignDistance(aPF1, aPlnToCompare);
    if (d1 < 0.) {
...
//purpose  :
//=======================================================================
  TopAbs_Orientation XBOPTools_Tools3D::Orientation(const TopoDS_Edge& anE,
						   const TopoDS_Face& aF)
{
...
//purpose  :
//=======================================================================
  Standard_Real XBOPTools_Tools3D::SignDistance(const gp_Pnt& aP, 
					       const gp_Pln& aPln)
{
...
// purpose: 
//=======================================================================
  Standard_Boolean XBOPTools_Tools3D::IsValidArea (const TopoDS_Face& aF, 
		 ...
		 const Standard_Boolean aSt) 
{
  ...
  XBOPTools_Tools3D::OrientEdgeOnFace (aE, aFF, aERight);
  //
  //
  Standard_Real aTolE, aDt2D;
  GeomAbs_SurfaceType aType;
  {
    aDt2D=XBOPTools_Tools3D::MinStepIn2d();
    //
  ...
  //
  XBOPTools_Tools3D::PointNearEdge (aERight, aFF, aT, aDt2D, aPInFace2D, aPInFace);
  //
  if (BRep_Tool::IsClosed(aE, aF)) {
    ...
    if (!(X >= UMin && X <= UMax && Y >= VMin && Y <= VMax)) {
      aERight.Reverse();
      XBOPTools_Tools3D::PointNearEdge (aERight, aFF, aT, aPInFace2D, aPInFace);
    }
  }
				      ...
				      const BRepAdaptor_Surface& BS2)
{
  ...
  for(anExpE.Init(aF1, TopAbs_EDGE); anExpE.More(); anExpE.Next()) {
    ...
    if( !aC3D.IsNull() ) {
      Standard_Real pM = XBOPTools_Tools2D::IntermediatePoint(pF, pL);
