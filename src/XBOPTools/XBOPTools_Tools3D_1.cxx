...
//purpose  : 
//=======================================================================
void XBOPTools_Tools3D::GetApproxNormalToFaceOnEdge (const TopoDS_Edge& aE,
						      ...
						      gp_Dir& aDNF)
{
  ...
  //gp_Pnt aPNear;
  gp_Pnt2d aPx2DNear;
  XBOPTools_Tools3D::PointNearEdge (aE, aF, aT, aPx2DNear, aPNear);
...
//purpose  : 
//=======================================================================
  void XBOPTools_Tools3D::PointNearEdge (const TopoDS_Edge& aE,
					const TopoDS_Face& aF,
					const Standard_Real aT, 
...
//=======================================================================
  void XBOPTools_Tools3D::PointNearEdge (const TopoDS_Edge& aE,
					...
					gp_Pnt& aPxNear)
{
  Standard_Real dt2D=XBOPTools_Tools3D::MinStepIn2d();//~1.e-5;
  //
  XBOPTools_Tools3D::PointNearEdge (aE, aF, aT, dt2D, aPx2DNear, aPxNear);
}
...
//purpose  : 
//=======================================================================
  void XBOPTools_Tools3D::PointToCompare (const gp_Pnt& aP1,
					 const gp_Pnt& aP2,
					 const TopoDS_Face& aF,
					 gp_Pnt& aPF,
...
//purpose  : 
//=======================================================================
  void XBOPTools_Tools3D::GetPlane (const TopoDS_Edge& aSpEF1,
				   ...
				   const Handle(XIntTools_Context)& aContext)
{
  ...
  aStPF=TopAbs_OUT;
  //
  aDt2D=XBOPTools_Tools3D::MinStepIn2d();//~1.e-5;
  ...
  //
  XBOPTools_Tools3D::PointNearEdge (aEF1, aF1, aT, aDt2D, aPx2DNear, aPxNear);
  //
  ...
  if (aD<aTolF2) {
    ...
    XBOPTools_Tools3D::GetNormalToSurface (aS2, U, V, aDNF2);
    ...
    //
    aD=XBOPTools_Tools3D::SignDistance(aPxNear, aPlnF2);
...
//purpose  : 
//=======================================================================
  void XBOPTools_Tools3D::GetPointState (const TopoDS_Edge& aSpEF2,
					...
					TopAbs_State& aStPF)
{
  ...
  //
  aDt2dMin=XBOPTools_Tools3D::MinStepIn2d();
  //
  if (aDt2D < aDt2dMin) {
    aDt2D=aDt2dMin;
  }
  ...
  //
  XBOPTools_Tools3D::OrientEdgeOnFace (aEF2, aF2adjF, aEF2Right);
  //
  XBOPTools_Tools3D::PointNearEdge (aEF2Right, aF2adjF, aT, aDt2D, aPx2DNear, aPxNear);
  //
  // Normal to the face aF1 at the point aPxOnF1
  XBOPTools_Tools3D::GetNormalToSurface (aS1, aPxOnF1.X(), aPxOnF1.Y(), aDNF1);
  ...
  Standard_Real aD;
  aD=XBOPTools_Tools3D::SignDistance(aPxNear, aPlnF1);
  if (aD<=0.) {
    aStPF=TopAbs_IN;
  }
}
...
//purpose  : 
//=======================================================================
  void XBOPTools_Tools3D::OrientEdgeOnFace (const TopoDS_Edge& aE,
					   const TopoDS_Face& aF,
					   TopoDS_Edge& aERight)
{
...
//purpose  : 
//=======================================================================
  TopAbs_Orientation XBOPTools_Tools3D::OrientTouchEdgeOnF1 (const TopoDS_Edge& aSpEF2,
							    const TopoDS_Edge& aEF2,
							    const TopoDS_Face& aF2adj,
							    const TopoDS_Face& aF1)
{
  ...
  TopoDS_Edge aEF2Right;
  XBOPTools_Tools3D::OrientEdgeOnFace (aEF2, aF2adjF, aEF2Right);
  XBOPTools_Tools3D::PointNearEdge (aEF2Right, aF2adjF, aT, aPx2DNear, aPxNear);
  //
  // Normal to aF2adj
  gp_Dir aDNF2;
  Handle(Geom_Surface) aS2=BRep_Tool::Surface(aF2adj);
  XBOPTools_Tools3D::GetNormalToSurface (aS2, aPx2DNear.X(), aPx2DNear.Y(), aDNF2);
  ...
  // Tangent for split
  gp_Vec aTE;
  XBOPTools_Tools2D::TangentOnEdge(aT, aSpEF2, aTE);
  gp_Dir aDTE(aTE); 
...
// purpose: 
//=======================================================================
  void XBOPTools_Tools3D::GetSeams (const TopoDS_Face& aF,
				   TopoDS_Edge& aSim1,
				   TopoDS_Edge& aSim2)
{
...
// purpose: 
//=======================================================================
  void XBOPTools_Tools3D::GetSeam (const TopoDS_Face& aF,
...
//purpose  : 
//=======================================================================
  Standard_Real XBOPTools_Tools3D::MinStepIn2d()
{
...
//purpose  : 
//=======================================================================
  Standard_Boolean XBOPTools_Tools3D::IsEmptyShape(const TopoDS_Shape& aS)
{
...
// purpose: 
//=======================================================================
  void XBOPTools_Tools3D::InvertShape(const TopoDS_Shape& aS,
...
// purpose: 
//=======================================================================
  TopAbs_State  XBOPTools_Tools3D::GetStatePartIN2D(const TopoDS_Edge& aSp,
						   const TopoDS_Edge& aEF1,
						   const TopoDS_Face& aF1,
						   const TopoDS_Face& aF2,
						   const Handle(XIntTools_Context)& aContext)
{
  ...
  XBOPTools_Tools3D::GetBiNormal (aSp, aF1, aDBF1);
  XBOPTools_Tools3D::GetNormalToFaceOnEdge (aSp, aF2, aDNF2);
  ...
  if (fabs(aScPr) < aTolScPr) {
    ...
    XBOPTools_Tools3D::GetPlane(aSp, aEF1, aF1, aF2, aStPF, aContext);
    aScPr=1.; // >0.
    if (aStPF==TopAbs_IN) {
      aScPr=-1.; // <0.
    }
...
// purpose: 
// ===========================================================================================
Standard_Boolean XBOPTools_Tools3D::ComputeFaceState(const TopoDS_Face&  theFace,
						    ...
						    TopAbs_State&       theState) 
{
  ...
  for(i = 1; !bFoundValidPoint && (i <= nbpoints); i++, U+=adeltau) {
	...
	if(aState != TopAbs_ON) {
	  ...
	  if(!aSolidClassifier.Rejected()) {
	    ...
	    if(!aFace2.IsNull()) {
	      if(XBOPTools_Tools3D::CheckSameDomainFaceInside(theFace, aFace2, theContext))
		aState = TopAbs_ON;
	      else {
		break;
	      }
  ...
  if(!bFoundInFacePoint) {
    ...
    for(; aExp.More(); aExp.Next()) {
      ...
      XBOPTools_Tools3D::PointNearEdge (aE, theFace, aT, aDt2D, aPoint, aP3d);
      //
      if (theContext->IsPointInOnFace(theFace, aPoint)) {
        bFoundInFacePoint = Standard_True;
...
//          theFace2 
// ===========================================================================================
Standard_Boolean XBOPTools_Tools3D::CheckSameDomainFaceInside(const TopoDS_Face& theFace1,
