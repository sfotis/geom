...
#include <XIntTools_FaceFace.ixx>
...
#include <XIntTools_Tools.hxx>
#include <XIntTools_TopolTool.hxx>
...
static 
  Standard_Boolean DecompositionOfWLine(const Handle(IntPatch_WLine)& theWLine,
					...
					const XIntTools_LineConstructor&                theLConstructor,
...
static void  PerformPlanes(const Handle(GeomAdaptor_HSurface)& theS1, 
			   ...
			   const Standard_Boolean theApprox2,
                           XIntTools_SequenceOfCurves& theSeqOfCurve, 
...
//purpose  : 
//=======================================================================
XIntTools_FaceFace::XIntTools_FaceFace()
{
...
//purpose  : 
//======================================================================= 
void XIntTools_FaceFace::SetContext(const Handle(XIntTools_Context)& aContext)
{
  myContext=aContext;
}
//=======================================================================
...
//purpose  : 
//======================================================================= 
const Handle(XIntTools_Context)& XIntTools_FaceFace::Context()const
{
  return myContext;
}
//=======================================================================
...
//purpose  : 
//======================================================================= 
const TopoDS_Face& XIntTools_FaceFace::Face1() const
{
  return myFace1;
}
//=======================================================================
...
//purpose  : 
//======================================================================= 
const TopoDS_Face& XIntTools_FaceFace::Face2() const
{
  return myFace2;
}
//=======================================================================
...
//purpose  : 
//======================================================================= 
Standard_Boolean XIntTools_FaceFace::TangentFaces() const
{
...
//purpose  : 
//======================================================================= 
const XIntTools_SequenceOfPntOn2Faces& XIntTools_FaceFace::Points() const
{
  return myPnts;
}
//=======================================================================
...
//purpose  : 
//======================================================================= 
Standard_Boolean XIntTools_FaceFace::IsDone() const
{
  return myIsDone;
}
//=======================================================================
...
//purpose  : 
//=======================================================================
Standard_Real XIntTools_FaceFace::TolReached3d() const
{
...
//=======================================================================
const XIntTools_SequenceOfCurves& XIntTools_FaceFace::Lines() const
{
  StdFail_NotDone_Raise_if
    (!myIsDone,
     "XIntTools_FaceFace::Lines() => !myIntersector.IsDone()");
  return mySeqOfCurve;
}
//=======================================================================
...
//purpose  : 
//=======================================================================
Standard_Real XIntTools_FaceFace::TolReached2d() const
{
...
//
// =======================================================================
void XIntTools_FaceFace::SetParameters(const Standard_Boolean ToApproxC3d,
...
//purpose  : 
//=======================================================================
void XIntTools_FaceFace::SetList(IntSurf_ListOfPntOn2S& aListOfPnts)
{
...
//=======================================================================
  void XIntTools_FaceFace::Perform(const TopoDS_Face& aF1,
				  const TopoDS_Face& aF2)
{
  ...
  Handle(XIntTools_TopolTool) dom1, dom2;
  ...
  if(aType1==GeomAbs_Plane && aType2==GeomAbs_Plane){
	...
	if (bReverse) {
	  ...
	  for (i=1; i<=aNbLin; ++i) {
	    XIntTools_Curve& aIC=mySeqOfCurve(i);
  ...
  //
  dom1 = new XIntTools_TopolTool(myHS1);
  dom2 = new XIntTools_TopolTool(myHS2);
  //
  ...
  if (myIsDone) {
    ...
    XIntTools_PntOnFace aPntOnF1, aPntOnF2;
    XIntTools_PntOn2Faces aPntOn2Faces;
    //
...
//purpose  : 
//=======================================================================
  void XIntTools_FaceFace::ComputeTolReached3d()
{
  ...
  if (aType1==GeomAbs_Cylinder && aType2==GeomAbs_Cylinder) {
    ...
    if (aNbLin) {// Check the distances
      ...
      //
      for (i=1; i<=aNbLin; ++i) {
	const XIntTools_Curve& aIC=mySeqOfCurve(i);
  ...
  //
    ...
    gp_Pnt aP, aPP, aPT;
    //
    const XIntTools_Curve& aIC=mySeqOfCurve(1);
    const Handle(Geom_Curve)& aC3D=aIC.Curve();
...
//purpose  : 
//=======================================================================
  void XIntTools_FaceFace::MakeCurve(const Standard_Integer Index,
 ...
 reapprox:;
  ...
  case IntPatch_Hyperbola: {
	...
	if (typl == IntPatch_Parabola) {
	  ...
	  myTolReached3d=XIntTools_Tools::CurveTolerance(aCT3D, aTolBase);
	}
	//
	...
	if (ok) {
	  Handle(Geom2d_BSplineCurve) H1;
	  mySeqOfCurve.Append(XIntTools_Curve(newc, H1, H1));
	}
      }
...
// 	  if (Abs(fprm) < RealEpsilon() &&  Abs(lprm-2.*M_PI) < RealEpsilon()) {
  ...
  case IntPatch_Analytic: {
	...
	// 	 
	mySeqOfCurve.Append(XIntTools_Curve(MakeBSpline(WL,1,WL->NbPnts()), H1, H2));
      }
    } // if (!myApprox)
  ...
  case IntPatch_Walking:{
	...
	XIntTools_Curve aIC(aBSp, H1, H2);
...
//       while(U0-umin<aEps) { 
  ...
  if (C2d.IsNull()) {
    XBOPTColStd_Dump::PrintMessage("BuildPCurves()=> Echec ProjLib\n");
  }
}
...
//purpose  : 
//=======================================================================
  void XIntTools_FaceFace::PrepareLines3D(const Standard_Boolean bToSplit)
{
  Standard_Integer i, aNbCurves;
  GeomAbs_SurfaceType aType1, aType2;
  XIntTools_SequenceOfCurves aNewCvs;
  //
  ...
  for (i=1; i<=aNbCurves; ++i) {
    ...
    if (bToSplit) {
      ...
      XIntTools_SequenceOfCurves aSeqCvs;
      //
      aNbC=XIntTools_Tools::SplitCurve(aIC, aSeqCvs);
      if (aNbC) {
	for (j=1; j<=aNbC; ++j) {
	  const XIntTools_Curve& aICNew=aSeqCvs(j);
  ...
  if ((aType1==GeomAbs_Plane && aType2==GeomAbs_Cone) ||
	...
	XIntTools_SequenceOfCurves aSeqIn, aSeqOut;
	//
	for (i=1; i<=aNbCurves; ++i) {
	  const XIntTools_Curve& aIC=aNewCvs(i);
	  aSeqIn.Append(aIC);
	}
	//
	XIntTools_Tools::RejectLines(aSeqIn, aSeqOut);
	//
	aNewCvs.Clear();
	aNbCurves=aSeqOut.Length(); 
	for (i=1; i<=aNbCurves; ++i) {
	  const XIntTools_Curve& aIC=aSeqOut(i);
	  aNewCvs.Append(aIC);
	}
      }
    }
...
Standard_Real FindMaxSquareDistance (const Standard_Real aT1,
				     ...
				     const Handle(XIntTools_Context)& myContext)
{
