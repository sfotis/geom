...
#include <XIntTools_CurveRangeSample.ixx>

XIntTools_CurveRangeSample::XIntTools_CurveRangeSample()
{
  myIndex = 0;
}

XIntTools_CurveRangeSample::XIntTools_CurveRangeSample(const Standard_Integer theIndex)
{
  myIndex = theIndex;
}

XIntTools_Range XIntTools_CurveRangeSample::GetRange(const Standard_Real    theFirst,
						   const Standard_Real    theLast,
						   const Standard_Integer theNbSample) const
{
  Standard_Real diffC = theLast - theFirst;
  XIntTools_Range aResult;
