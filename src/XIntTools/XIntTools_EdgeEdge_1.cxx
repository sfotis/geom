...
//=======================================================================
//class    : XIntTools_ComparatorCurve
//purpose  : 
//=======================================================================
class XIntTools_ComparatorCurve {
 public: 
  XIntTools_ComparatorCurve() {
    myT11=0.;
    myT12=0.;
    myT21=0.;
    myT22=0.;
  ...
  //
  virtual ~XIntTools_ComparatorCurve(){
  }; 
  //
...
//purpose  : 
//=======================================================================
void XIntTools_ComparatorCurve::Perform()
{
...
//purpose  : 
//=======================================================================
void XIntTools_ComparatorCurve::IsSameBSplineCurve()
{
...
//purpose  : 
//=======================================================================
void XIntTools_ComparatorCurve::GetCurveBase(const Handle(Geom_Curve)& aC3D,
					    GeomAbs_CurveType& aTypeBase,
					    Handle(Geom_Curve)& aCurveBase)
{
...
//=======================================================================
Standard_Boolean 
  XIntTools_ComparatorCurve::IsTypeBase(const Handle(Geom_Curve)& aC,
				       GeomAbs_CurveType& aTypeB)
{
...
//purpose  : 
//=======================================================================
void XIntTools_ComparatorCurve::IsSameElipse()
{
...
//=======================================================================
Standard_Boolean 
  XIntTools_ComparatorCurve::IsSameAx2(const gp_Ax2& aAx21, 
				      const gp_Ax2& aAx22)
{
  Standard_Boolean bRet;
  //
...
//=======================================================================
Standard_Boolean 
  XIntTools_ComparatorCurve::IsSamePnt(const gp_Pnt& aP1, 
				      const gp_Pnt& aP2)
{
...
//=======================================================================
Standard_Boolean 
  XIntTools_ComparatorCurve::IsSameAx1(const gp_Ax1& aAx1, 
				      const gp_Ax1& aAx2)
{
  Standard_Boolean bRet;
  //
...
//=======================================================================
Standard_Boolean 
  XIntTools_ComparatorCurve::IsSameDir(const gp_Dir& aDir1, 
				      const gp_Dir& aDir2)
{
...
//=======================================================================
Standard_Boolean 
  XIntTools_ComparatorCurve::IsSameXYZ(const gp_XYZ& aXYZ1, 
				      const gp_XYZ& aXYZ2)
{
  Standard_Boolean bRet;
  Standard_Integer i;
...
//=======================================================================
Standard_Boolean 
  XIntTools_ComparatorCurve::IsSameReal(const Standard_Real aR1, 
				       const Standard_Real aR2)
{
  Standard_Boolean bRet;
...
//purpose  : 
//=======================================================================
void XIntTools_DistCC::CheckData()
{
  myErrorStatus=0;
  //
  if (myC1.IsNull()) {
...
//purpose  : 
//=======================================================================
void XIntTools_DistCC::FindMaxDeviation()
{ 
...
//=======================================================================
void XIntTools_DistCC::FindMaxLocal(const Standard_Real aT11,
				   const Standard_Real aT12,
				   const Standard_Real aEps,
				   Standard_Real& aDx,
				   Standard_Real& aTx)
...
//purpose  : 
//=======================================================================
Standard_Real XIntTools_DistCC::Distance(const Standard_Real aT)
{
...
//purpose  : 
//=======================================================================
Standard_Boolean XIntTools_EdgeEdge::IsSameCurves()
{
  Standard_Boolean bRet, bIsBC;
  GeomAbs_CurveType aCT1, aCT2;
  XIntTools_ComparatorCurve aICC;
  //
  // 1. Check letter
