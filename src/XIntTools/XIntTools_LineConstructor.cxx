...
#include <XIntTools_LineConstructor.ixx>
...
//purpose  : 
//=======================================================================
void XIntTools_LineConstructor::Perform(const Handle(IntPatch_Line)& L)
{
		...
		Standard_Real& V1)
{
  ...
  switch (myHS1->Surface().GetType())  {
    ...
    case GeomAbs_Sphere:   
      ...
      break;
    default: 
      Standard_ConstructionError::Raise("XIntTools_LineConstructor::Parameters");
  }
...
//
//=======================================================================
//class    : XIntTools_RealWithFlag
//purpose  : 
//=======================================================================
class XIntTools_RealWithFlag {
 public:
  XIntTools_RealWithFlag() : 
    myValue(-99.), myFlag(1) 
  {
  };
  //
  ...
  //
  Standard_Boolean operator < (const XIntTools_RealWithFlag& aOther) {
...
//purpose  : 
//=======================================================================
void XIntTools_LineConstructor::TreatCircle(const Handle(IntPatch_Line)& aLine,
...
{  
  ...
  //-------------------------------------
  //
  pVtx=new XIntTools_RealWithFlag [aNbVtx];
  //
  pVtx[0].SetValue(0.);
...
void SortShell(const Standard_Integer n, 
	       XIntTools_RealWithFlag *a) 
{
  Standard_Integer nd, i, j, l, d=1;
  XIntTools_RealWithFlag x;
  //
  while(d<=n) {
    d*=2;
  }
