...
#include <XIntTools_EdgeFace.ixx>



#include <XIntTools_CArray1OfReal.hxx>
#include <XIntTools.hxx>
#include <XIntTools_CArray1OfInteger.hxx>
...
#include <XIntTools_BeanFaceIntersector.hxx>
...
//=======================================================================
//function : XIntTools_EdgeFace::XIntTools_EdgeFace
//purpose  : 
//=======================================================================
  XIntTools_EdgeFace::XIntTools_EdgeFace()
{
  myTolE=1.e-7;
  myTolF=1.e-7;
  myDiscret=30;
...
//purpose  : 
//=======================================================================
void XIntTools_EdgeFace::SetContext(const Handle(XIntTools_Context)& theContext) 
{
...
//purpose  : 
//=======================================================================
const Handle(XIntTools_Context)& XIntTools_EdgeFace::Context()const 
{
  return myContext;
}
//=======================================================================
...
//purpose  : 
//=======================================================================
  void XIntTools_EdgeFace::SetEdge(const TopoDS_Edge& anEdge)
{
  myEdge=anEdge;
}
...
//purpose  : 
//=======================================================================
  void XIntTools_EdgeFace::SetFace(const TopoDS_Face& aFace)
{
  myFace=aFace;
}
...
//purpose  : 
//=======================================================================
  void XIntTools_EdgeFace::SetTolE(const Standard_Real aTol) 
{
  myTolE=aTol;
} 
//=======================================================================
...
//purpose  : 
//=======================================================================
  void XIntTools_EdgeFace::SetTolF(const Standard_Real aTol) 
{
  myTolF=aTol;
} 
...
//purpose  : 
//=======================================================================
  void XIntTools_EdgeFace::SetDiscretize(const Standard_Integer aDiscret)
{
  myDiscret=aDiscret;
}
//=======================================================================
...
//purpose  : 
//=======================================================================
  void XIntTools_EdgeFace::SetDeflection(const Standard_Real aDefl) 
{
  myDeflection=aDefl;
} 
//=======================================================================
...
//purpose  : 
//=======================================================================
  void XIntTools_EdgeFace::SetEpsilonT(const Standard_Real anEpsT) 
{
  myEpsT=anEpsT;
} 
//=======================================================================
...
//purpose  : 
//=======================================================================
  void XIntTools_EdgeFace::SetEpsilonNull(const Standard_Real anEpsNull) 
{
  myEpsNull=anEpsNull;
} 
...
//purpose  : 
//=======================================================================
  void XIntTools_EdgeFace::SetRange(const Standard_Real aFirst,
...
//purpose  : 
//=======================================================================
  void XIntTools_EdgeFace::SetRange(const XIntTools_Range& aRange) 
{
...
//purpose  : 
//=======================================================================
Standard_Boolean XIntTools_EdgeFace::IsDone()const 
{
  return myIsDone;
} 
//=======================================================================
...
//purpose  : 
//=======================================================================
Standard_Integer XIntTools_EdgeFace::ErrorStatus()const 
{
...
//purpose  : 
//=======================================================================
const XIntTools_SequenceOfCommonPrts& XIntTools_EdgeFace::CommonParts() const 
{
...
//purpose  : 
//=======================================================================
const XIntTools_Range&  XIntTools_EdgeFace::Range() const
{
  return myRange;
} 
...
//purpose  : 
//=======================================================================
void XIntTools_EdgeFace::CheckData()
{
...
//purpose  : 
//=======================================================================
  void XIntTools_EdgeFace::Prepare() 
{
  Standard_Integer pri;
  XIntTools_CArray1OfReal aPars;
  ...
  //
  // 3.Prepare myPars 
  pri = XIntTools::PrepareArgs(myC, myTmax, myTmin, myDiscret, myDeflection, aPars);
  if (pri) {
    myErrorStatus=6;
    return;
  }
  ...
  aNb=aPars.Length();
  XIntTools_CArray1OfInteger anArrProjectability;
...
//purpose  : 
//=======================================================================
  void XIntTools_EdgeFace::FindProjectableRoot (const Standard_Real tt1,
...
//purpose  : 
//=======================================================================
  Standard_Boolean XIntTools_EdgeFace::IsProjectable(const Standard_Real t) const
{
...
//purpose  : 
//=======================================================================
  Standard_Real XIntTools_EdgeFace::DistanceFunction(const Standard_Real t)
{
  ...
  bIsEqDistance= XIntTools_EdgeFace::IsEqDistance(P, myS, 1.e-7, aD); 
  if (bIsEqDistance) {
    aD=aD-myCriteria;
    return aD; 
  }
...
//purpose  : 
//=======================================================================
  Standard_Boolean XIntTools_EdgeFace::IsEqDistance(const gp_Pnt& aP,
...
//=======================================================================		
  void XIntTools_EdgeFace::PrepareArgsFuncArrays(const Standard_Real ta,
						const Standard_Real tb)
{
  XIntTools_CArray1OfReal anArgs, aFunc;
  Standard_Integer i, aNb, pri;
  Standard_Real t, f, f1;
  //
  // Prepare values of arguments for the interval [ta, tb]
  pri=XIntTools::PrepareArgs (myC, tb, ta, myDiscret, myDeflection, anArgs);
...
//purpose  : 
//=======================================================================
  void XIntTools_EdgeFace::AddDerivativePoints(const XIntTools_CArray1OfReal& t,
					      const XIntTools_CArray1OfReal& f)  
{
  Standard_Integer i, j, n, k, nn=100;
  Standard_Real fr, tr, tr1, dEpsNull=10.*myEpsNull;
  XIntTools_CArray1OfReal fd;
  ...
  if (nn) {
    k=nn+n;
    XIntTools_Array1OfRange anArray1OfRange(1, k);
    for (i=1; i<=n; i++) {
    ...
    XIntTools_QuickSortRange aQuickSortRange;
    XIntTools_CompareRange aComparator;
...
//purpose  : 
//=======================================================================
  Standard_Real XIntTools_EdgeFace::DerivativeFunction(const Standard_Real t2)
{
...
//purpose  : [private]
//=======================================================================
  Standard_Real XIntTools_EdgeFace::FindSimpleRoot (const Standard_Integer IP,
...
//purpose  : [private]
//=======================================================================
  Standard_Real XIntTools_EdgeFace::FindGoldRoot (const Standard_Real tA,
						 const Standard_Real tB,
...
//purpose  : 
//=======================================================================
  Standard_Integer XIntTools_EdgeFace::MakeType(XIntTools_CommonPrt&  aCommonPrt)
{
...
//purpose  : 
//=======================================================================
  void XIntTools_EdgeFace::IsIntersection (const Standard_Real ta, 
					  const Standard_Real tb) 
{
  XIntTools_CArray1OfReal anArgs, aFunc;
...
//purpose  : 
//=======================================================================
  void XIntTools_EdgeFace::FindDerivativeRoot(const XIntTools_CArray1OfReal& t,
					     const XIntTools_CArray1OfReal& f)  
{
...
//purpose  : 
//=======================================================================
  void XIntTools_EdgeFace::RemoveIdenticalRoots()
{
  Standard_Integer aNbRoots, j, k;

  aNbRoots=mySequenceOfRoots.Length();
  for (j=1; j<=aNbRoots; j++) { 
    const XIntTools_Root& aRj=mySequenceOfRoots(j);
    for (k=j+1; k<=aNbRoots; k++) {
      const XIntTools_Root& aRk=mySequenceOfRoots(k);
...
//purpose  : 
//=======================================================================
  Standard_Boolean XIntTools_EdgeFace::CheckTouch(const XIntTools_CommonPrt& aCP,
						 Standard_Real&            aTx) 
{
...
//purpose  : 
//=======================================================================
  void XIntTools_EdgeFace::Perform() 
{
  Standard_Integer i, aNb;
  XIntTools_CommonPrt aCommonPrt;
  //
  ...
  XIntTools_BeanFaceIntersector anIntersector(myC, myS, myTolE, myTolF);
  ...
  for(Standard_Integer r = 1; r <= anIntersector.Result().Length(); r++) {
    const XIntTools_Range& aRange = anIntersector.Result().Value(r);
    
    if(IsProjectable(XIntTools_Tools::IntermediatePoint(aRange.First(), aRange.Last()))) {
  ...
  for (i=1; i<=aNb; i++) {
    XIntTools_CommonPrt& aCP=mySeqOfCommonPrts.ChangeValue(i);
    //
  ...
  }
  {
    ...
    if (aCType==GeomAbs_Line && aSType==GeomAbs_Cylinder) {
      for (i=1; i<=aNb; i++) {
	XIntTools_CommonPrt& aCP=mySeqOfCommonPrts(i);
	aType=aCP.Type();
...
//purpose  : 
//=======================================================================
  Standard_Boolean XIntTools_EdgeFace::CheckTouchVertex (const XIntTools_CommonPrt& aCP,
							Standard_Real& aTx) 
{
			       ...
			       const BRepAdaptor_Surface& aSurface)
{
  ...
  if (aCType==GeomAbs_Circle && aSType==GeomAbs_Plane) {
    ...
    bFlag=XIntTools_Tools::IsDirsCoinside(aDirAx1, aDirPln);
  }
  return bFlag;
}
//=======================================================================
				  ...
				  const BRepAdaptor_Surface& aSurface)
{
  ...
  if (aSType==GeomAbs_Cylinder) {
   ...
   aELength=XIntTools::Length(aCurve.Edge());
