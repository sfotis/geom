...
#endif
//=======================================================================
//function : XIntTools::GetRadius
//purpose  : 
//=======================================================================
  Standard_Integer XIntTools::GetRadius(const BRepAdaptor_Curve& C,
...
//purpose  : 
//=======================================================================
  Standard_Integer XIntTools::PrepareArgs(BRepAdaptor_Curve& C,
					 ...
					 XIntTools_CArray1OfReal& anArgs)
{
  ...
  for (i=1; i<=Discret; i++) {
    ...
    //
    ip=XIntTools::GetRadius (C, tCurrent, tNext, aR);  
    if (ip<0) {
      return 1;
    }
    //
...
//=======================================================================
//function : XIntTools::Length
//purpose  : 
//=======================================================================
  Standard_Real XIntTools::Length (const TopoDS_Edge& anEdge)
{
...
//purpose  : 
//=======================================================================
  void XIntTools::RemoveIdenticalRoots(XIntTools_SequenceOfRoots& aSR,
				      const Standard_Real anEpsT)
{
  ...
  for (j=1; j<=aNbRoots; j++) { 
    const XIntTools_Root& aRj=aSR(j);
    for (k=j+1; k<=aNbRoots; k++) {
      const XIntTools_Root& aRk=aSR(k);
...
//purpose  : 
//=======================================================================
  void XIntTools::SortRoots(XIntTools_SequenceOfRoots& mySequenceOfRoots,
			   const Standard_Real myEpsT)
{
  ...
  XIntTools_Array1OfRoots anArray1OfRoots(1, aNbRoots);
  XIntTools_Compare aComparator(myEpsT);
  
  for (j=1; j<=aNbRoots; j++) {
    anArray1OfRoots(j)=mySequenceOfRoots(j);
  }
  
  XIntTools_QuickSort aQS;
...
//purpose  : 
//=======================================================================
  void  XIntTools::FindRootStates(XIntTools_SequenceOfRoots& mySequenceOfRoots,
				 const Standard_Real myEpsNull)
{
  ...
  for (j=1; j<=aNbRoots; j++) {
    XIntTools_Root& aR=mySequenceOfRoots.ChangeValue(j);
...
//purpose  :
//=======================================================================
  Standard_Integer  XIntTools::Parameter (const gp_Pnt& aP,
