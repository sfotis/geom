...
#include <XIntTools_BeanFaceIntersector.ixx>
...
static Standard_Boolean SetEmptyResultRange(const Standard_Real      theParameter, 
					    XIntTools_MarkedRangeSet& theMarkedRange);
...
static Bnd_Box GetSurfaceBox
		...
		const Standard_Real                       theTolerance,
		      XIntTools_SurfaceRangeLocalizeData  &theSurfaceData);
...
static void MergeSolutions(const XIntTools_ListOfCurveRangeSample& theListCurveRange,
			   const XIntTools_ListOfSurfaceRangeSample& theListSurfaceRange,
			   XIntTools_ListOfCurveRangeSample& theListCurveRangeSort,
			   XIntTools_ListOfSurfaceRangeSample& theListSurfaceRangeSort);

static void CheckSampling(const XIntTools_CurveRangeSample& theCurveRange,
			  const XIntTools_SurfaceRangeSample& theSurfaceRange,
			  const XIntTools_CurveRangeLocalizeData& theCurveData,
			  const XIntTools_SurfaceRangeLocalizeData& theSurfaceData,
...
// ==================================================================================
// function: XIntTools_BeanFaceIntersector
// purpose: 
// ==================================================================================
XIntTools_BeanFaceIntersector::XIntTools_BeanFaceIntersector() :
myFirstParameter(0.),
myLastParameter(0.),
myUMinParameter(0.),
myUMaxParameter(0.),
...
// purpose: 
// ==================================================================================
XIntTools_BeanFaceIntersector::XIntTools_BeanFaceIntersector(const TopoDS_Edge& theEdge,
...
// purpose: 
// ==================================================================================
XIntTools_BeanFaceIntersector::XIntTools_BeanFaceIntersector(const BRepAdaptor_Curve&   theCurve,
							   const BRepAdaptor_Surface& theSurface,
...
// purpose: 
// ==================================================================================
void XIntTools_BeanFaceIntersector::Init(const TopoDS_Edge& theEdge,
					const TopoDS_Face& theFace) 
{
...
// purpose: 
// ==================================================================================
void XIntTools_BeanFaceIntersector::Init(const BRepAdaptor_Curve&   theCurve,
					const BRepAdaptor_Surface& theSurface,
					const Standard_Real        theBeanTolerance,
					const Standard_Real        theFaceTolerance) 
{
...
// purpose: 
// ==================================================================================
void XIntTools_BeanFaceIntersector::SetContext(const Handle(XIntTools_Context)& theContext) 
{
...
// purpose: 
// ==================================================================================
const Handle(XIntTools_Context)& XIntTools_BeanFaceIntersector::Context()const
{
  return myContext;
}
...
// purpose: 
// ==================================================================================
void XIntTools_BeanFaceIntersector::SetBeanParameters(const Standard_Real theFirstParOnCurve,
						     const Standard_Real theLastParOnCurve) 
{
  myFirstParameter = theFirstParOnCurve;
  myLastParameter  = theLastParOnCurve;
...
// purpose: 
// ==================================================================================
void XIntTools_BeanFaceIntersector::SetSurfaceParameters(const Standard_Real theUMinParameter,
							const Standard_Real theUMaxParameter,
							const Standard_Real theVMinParameter,
							const Standard_Real theVMaxParameter) 
{
...
// purpose: 
// ==================================================================================
void XIntTools_BeanFaceIntersector::Perform() 
{
  myIsDone = Standard_False;
  myResults.Clear();
...
// modified by NIZHNY-MKK  Wed Oct 19 12:15:26 2005.END
    ...
    XIntTools_CArray1OfReal aParams;
    
    if(XIntTools::PrepareArgs(myCurve, 
			     myLastParameter, 
			     myFirstParameter, 
			     aDiscretization, 
			     aRelativeDeflection, 
    ...
    if(bRet) {
      XIntTools_Range aRange(myFirstParameter, myLastParameter);
...
//     else {
  ...
  for(Standard_Integer i = 1; i <= myRangeManager.Length(); i++) {
    ...
    if(myRangeManager.Flag(i) == 2) {
      XIntTools_Range aRange = myRangeManager.Range(i);

      if(myResults.Length() > 0) {
	const XIntTools_Range& aLastRange = myResults.Last();
...
// purpose: 
// ==================================================================================
const XIntTools_SequenceOfRanges& XIntTools_BeanFaceIntersector::Result() const
{
  return myResults;
}
...
// purpose: 
// ==================================================================================
void XIntTools_BeanFaceIntersector::Result(XIntTools_SequenceOfRanges& theResults) const
{
...
// purpose: 
// ==================================================================================
Standard_Real XIntTools_BeanFaceIntersector::Distance(const Standard_Real theArg)
{
...
// purpose: 
// ==================================================================================
void XIntTools_BeanFaceIntersector::ComputeAroundExactIntersection() 
{
...
// purpose: 
// ==================================================================================
Standard_Boolean XIntTools_BeanFaceIntersector::FastComputeExactIntersection() 
{
...
// purpose: 
// ==================================================================================
void XIntTools_BeanFaceIntersector::ComputeLinePlane() 
{
...
// purpose: 
// ==================================================================================
void XIntTools_BeanFaceIntersector::ComputeUsingExtremum() 
{
  ...
  for(Standard_Integer i = 1; i <= myRangeManager.Length(); i++) {
    ...
    XIntTools_Range aParamRange = myRangeManager.Range(i);
...
// purpose: 
// ==================================================================================
void XIntTools_BeanFaceIntersector::ComputeNearRangeBoundaries() 
{
  ...
  if(myRangeManager.Flag(myRangeManager.Length()) == 0) {
    XIntTools_Range aParamRange = myRangeManager.Range(myRangeManager.Length());
...
// ==================================================================================
void XIntTools_BeanFaceIntersector::ComputeRangeFromStartPoint(const Standard_Boolean ToIncreaseParameter,
							      ...
							      const Standard_Integer theIndex) 
{
  ...
  XIntTools_Range aCurrentRange = myRangeManager.Range(aValidIndex);
...
// purpose: 
// ======================================================================================================================
Standard_Boolean XIntTools_BeanFaceIntersector::LocalizeSolutions(const XIntTools_CurveRangeSample& theCurveRange,
								 const Bnd_Box& theBoxCurve,
								 const XIntTools_SurfaceRangeSample& theSurfaceRange,
								 const Bnd_Box& theBoxSurface,
								 XIntTools_CurveRangeLocalizeData& theCurveData,
								 XIntTools_SurfaceRangeLocalizeData& theSurfaceData,
								 XIntTools_ListOfCurveRangeSample& theListCurveRange,
								 XIntTools_ListOfSurfaceRangeSample& theListSurfaceRange) 
{
  Standard_Integer tIt = 0, uIt = 0, vIt = 0;

  // 
  XIntTools_CurveRangeSample aRootRangeC(0);
  aRootRangeC.SetDepth(0);
  XIntTools_SurfaceRangeSample aRootRangeS(0, 0, 0, 0);
  ...
  //
  XIntTools_ListOfCurveRangeSample aListCurveRangeFound;
  XIntTools_ListOfSurfaceRangeSample aListSurfaceRangeFound;


  XIntTools_Range aRangeC = theCurveRange.GetRange(myFirstParameter, myLastParameter, theCurveData.GetNbSample());
  ...
  XIntTools_Range aRangeV = theSurfaceRange.GetRangeV(myVMinParameter, myVMaxParameter, theSurfaceData.GetNbSampleV());

  //
  XIntTools_Range aRangeU = theSurfaceRange.GetRangeU(myUMinParameter, myUMaxParameter, theSurfaceData.GetNbSampleU());
  ...
  // init template. begin
  XIntTools_CurveRangeSample aNewRangeCTemplate;
  ...
  XIntTools_SurfaceRangeSample aNewRangeSTemplate = theSurfaceRange;
  ...
  for(uIt = 1; uIt <= nbU; uIt++, aCurIndexU++, aPrevParU = aCurParU) {
    ...
    for(vIt = 1; vIt <= nbV; vIt++, aCurIndexV++, aPrevParV = aCurParV) {
      ...
      // //////////////
      //
      XIntTools_SurfaceRangeSample aNewRangeS = aNewRangeSTemplate;
...
// 	}
	...
	continue;
      ...
      XIntTools_ListOfBox aListOfBox;
      ...
      XIntTools_CurveRangeSample aCurRangeC = aNewRangeCTemplate;
...
// 	  }
	...
	bHasOutV = Standard_True;
      ...
      XIntTools_CurveRangeSample aNewRangeC = aNewRangeCTemplate;

      aCurIndex = aCurIndexInit;
      TColStd_ListIteratorOfListOfInteger anItI(aListOfIndex);
      XIntTools_ListIteratorOfListOfBox anItBox(aListOfBox);
...
// 	theSurfaceData.AddBox(aNewRangeS, aBoxS);
  ...
  if(!bHasOut) {
    ...
    XIntTools_ListIteratorOfListOfCurveRangeSample anIt1(aListCurveRangeFound);
    XIntTools_ListIteratorOfListOfSurfaceRangeSample anIt2(aListSurfaceRangeFound);
...
// purpose: 
// ======================================================================================================================
Standard_Boolean XIntTools_BeanFaceIntersector::ComputeLocalized() {
  Standard_Real Tol = Precision::PConfusion();

  XIntTools_SurfaceRangeSample aSurfaceRange(0, 0, 0, 0);
  Standard_Real dMinU = 10. * Precision::PConfusion();
  Standard_Real dMinV = dMinU;
  XIntTools_SurfaceRangeLocalizeData aSurfaceDataInit(3, 3, dMinU, dMinV);
  XIntTools_SurfaceRangeLocalizeData& aSurfaceData = myContext->SurfaceData(mySurface.Face());
  ...
  XIntTools_ListOfCurveRangeSample aListCurveRange;
  XIntTools_ListOfSurfaceRangeSample aListSurfaceRange;
  
  XIntTools_CurveRangeSample aCurveRange(0);
  ...
  XIntTools_ListOfCurveRangeSample aListOut;

  // check
  Standard_Boolean bAllowSamplingC = Standard_True;
  Standard_Boolean bAllowSamplingU = Standard_True;
  Standard_Boolean bAllowSamplingV = Standard_True;
  XIntTools_CurveRangeLocalizeData aCurveDataTmp(nbSampleC, dMinC);
  XIntTools_SurfaceRangeLocalizeData aSurfaceDataTmp(nbSampleU, nbSampleV, dMinU, dMinV);
  ...
  {
    XIntTools_CurveRangeLocalizeData aCurveData(nbSampleC, dMinC);
    ...
    XIntTools_ListOfCurveRangeSample aListCurveRangeSort;
    XIntTools_ListOfSurfaceRangeSample aListSurfaceRangeSort;

    MergeSolutions(aListCurveRange, aListSurfaceRange, aListCurveRangeSort, aListSurfaceRangeSort);

    XIntTools_ListIteratorOfListOfCurveRangeSample anItC(aListCurveRangeSort);
    XIntTools_ListIteratorOfListOfSurfaceRangeSample anItS(aListSurfaceRangeSort);
    XIntTools_SurfaceRangeSample aRangeSPrev;

    Extrema_GenExtCS anExtremaGen;

    for(; anItC.More() && anItS.More(); anItC.Next(), anItS.Next()) {

      XIntTools_Range aRangeC(myFirstParameter, myLastParameter);

      if(bAllowSamplingC) 
	aRangeC = anItC.Value().GetRange(myFirstParameter, myLastParameter, nbSampleC);

      XIntTools_Range aRangeU(myUMinParameter, myUMaxParameter);

      if(bAllowSamplingU) 
	aRangeU = anItS.Value().GetRangeU(myUMinParameter, myUMaxParameter, nbSampleU);

      XIntTools_Range aRangeV(myVMinParameter, myVMaxParameter);
  ...
  //
  if(bAllowSamplingC) {
    XIntTools_ListIteratorOfListOfCurveRangeSample anItC(aListOut);

    for(; anItC.More(); anItC.Next()) {
      XIntTools_Range aRangeC =anItC.Value().GetRange(myFirstParameter, myLastParameter, nbSampleC);
...
// purpose: 
// ======================================================================================================================
Standard_Boolean XIntTools_BeanFaceIntersector::TestComputeCoinside()
{
...
static void MergeSolutions(const XIntTools_ListOfCurveRangeSample& theListCurveRange,
  ...
  XIntTools_ListIteratorOfListOfCurveRangeSample anItC2;
  XIntTools_ListIteratorOfListOfSurfaceRangeSample anItS1(theListSurfaceRange), anItS2;
  XIntTools_MapOfSurfaceSample aMapToAvoid;

  for(; anItS1.More(); anItS1.Next()) {
    const XIntTools_SurfaceRangeSample& aRangeS = anItS1.Value();
