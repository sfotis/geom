...
//purpose  : 
//=======================================================================
  Standard_Boolean XIntTools_Tools::HasInternalEdge(const TopoDS_Wire& aW)
{
...
//purpose  : 
//=======================================================================
  Standard_Boolean XIntTools_Tools::IsClosed (const Handle(Geom_Curve)& aC3D)
{
...
//purpose  : 
//=======================================================================
   void XIntTools_Tools::RejectLines(const XIntTools_SequenceOfCurves& aSIn,
				    XIntTools_SequenceOfCurves& aSOut)
{
  ...
  aNb=aSIn.Length();
  for (i=1; i<=aNb; i++) {
    const XIntTools_Curve& IC=aSIn(i);
    aC3D=IC.Curve();
    //
    ...
    if (!aGTC.IsNull()) {
      ...
      XIntTools_Curve* pIC=(XIntTools_Curve*) &IC;
      pIC->SetCurve(aC3D);
    }
    //
    ...
    bFlag=XIntTools_Tools::IsDirsCoinside(aD1, aD2);
    if (!bFlag) {
      aSOut.Append(IC);
      return;
    }
...
//purpose  : 
//=======================================================================
  Standard_Boolean XIntTools_Tools::IsDirsCoinside  (const gp_Dir& D1, const gp_Dir& D2)
{
  Standard_Boolean bFlag;
...
//purpose  : 
//=======================================================================
  Standard_Boolean XIntTools_Tools::IsDirsCoinside  (const gp_Dir& D1, 
						    const gp_Dir& D2,
...
//purpose  : 
//=======================================================================
  Standard_Integer XIntTools_Tools::SplitCurve(const XIntTools_Curve& IC,
					      XIntTools_SequenceOfCurves& aCvs)
{
  ...
  if (aCT==GeomAbs_BSplineCurve ||
    ...
    //aMid=0.5*aMid;
    aMid=XIntTools_Tools::IntermediatePoint(aF, aL);
  }
  //
  ...
  XIntTools_Curve aIC1(aC3DNewF, aC2D1F, aC2D2F);
  XIntTools_Curve aIC2(aC3DNewL, aC2D1L, aC2D2L);
  //
  aCvs.Append(aIC1);
  //
  aCvs.Append(aIC2);
...
//purpose  : 
//=======================================================================
  Standard_Real XIntTools_Tools::IntermediatePoint (const Standard_Real aFirst,
...
//purpose  : 
//=======================================================================
  Standard_Boolean XIntTools_Tools::IsVertex (const gp_Pnt& aP,
...
//purpose  : 
//=======================================================================
  Standard_Boolean XIntTools_Tools::IsVertex (const XIntTools_CommonPrt& aCmnPrt)
{
  Standard_Boolean anIsVertex;
  Standard_Real aParam;

  const TopoDS_Edge&    aE1=aCmnPrt.Edge1();
  const XIntTools_Range& aR1=aCmnPrt.Range1();
  aParam=0.5*(aR1.First()+aR1.Last());
  anIsVertex=XIntTools_Tools::IsVertex (aE1, aParam);
  ...
  const XIntTools_SequenceOfRanges& aRs2=aCmnPrt.Ranges2();
  const XIntTools_Range& aR2=aRs2(1);
  aParam=0.5*(aR2.First()+aR2.Last());
  anIsVertex=XIntTools_Tools::IsVertex (aE2, aParam);
  if (anIsVertex) {
    return Standard_True;
  }
  return Standard_False;
...
//purpose  : 
//=======================================================================
  Standard_Boolean XIntTools_Tools::IsVertex (const TopoDS_Edge& aE,
					     const TopoDS_Vertex& aV,
...
//purpose  : 
//=======================================================================
  Standard_Integer XIntTools_Tools::ComputeVV(const TopoDS_Vertex& aV1, 
...
//purpose  : 
//=======================================================================
  void XIntTools_Tools::MakeFaceFromWireAndFace(const TopoDS_Wire& aW,
...
//purpose  : 
//=======================================================================
  TopAbs_State XIntTools_Tools::ClassifyPointByFace(const TopoDS_Face& aF,
						   const gp_Pnt2d& aP2d)
{
  ...
  XIntTools_FClass2d aClass2d(aF, aFaceTolerance);
...
//purpose  : 
//=======================================================================
  Standard_Boolean XIntTools_Tools::IsMiddlePointsEqual(const TopoDS_Edge& aE1,
...
//purpose  : 
//=======================================================================
  Standard_Real XIntTools_Tools::CurveTolerance(const Handle(Geom_Curve)& aC3D,
