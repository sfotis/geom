...
#include <XIntTools_EdgeEdge.ixx>
...
#include <XIntTools_BeanBeanIntersector.hxx>


//=======================================================================
//function : XIntTools_EdgeEdge::XIntTools_EdgeEdge
//purpose  : 
//=======================================================================
XIntTools_EdgeEdge::XIntTools_EdgeEdge()
{
  myTol1=1.e-7;
  myTol2=1.e-7;
  myDiscret=30;
...
//purpose  : 
//=======================================================================
  void XIntTools_EdgeEdge::SetEdge1(const TopoDS_Edge& anEdge)
{
  myEdge1=anEdge;
}
//=======================================================================
...
//purpose  : 
//=======================================================================
  void XIntTools_EdgeEdge::SetEdge2(const TopoDS_Edge& anEdge)
{
  myEdge2=anEdge;
}
...
//purpose  : 
//=======================================================================
  void XIntTools_EdgeEdge::SetTolerance1(const Standard_Real aTol) 
{
  myTol1=aTol;
} 
//=======================================================================
...
//purpose  : 
//=======================================================================
  void XIntTools_EdgeEdge::SetTolerance2(const Standard_Real aTol) 
{
  myTol2=aTol;
} 
...
//purpose  : 
//=======================================================================
  void XIntTools_EdgeEdge::SetDiscretize(const Standard_Integer aDiscret)
{
  myDiscret=aDiscret;
}
//=======================================================================
...
//purpose  : 
//=======================================================================
  void XIntTools_EdgeEdge::SetDeflection(const Standard_Real aDefl) 
{
  myDeflection=aDefl;
} 
//=======================================================================
...
//purpose  : 
//=======================================================================
  void XIntTools_EdgeEdge::SetEpsilonT(const Standard_Real anEpsT) 
{
  myEpsT=anEpsT;
} 
//=======================================================================
...
//purpose  : 
//=======================================================================
  void XIntTools_EdgeEdge::SetEpsilonNull(const Standard_Real anEpsNull) 
{
  myEpsNull=anEpsNull;
} 
...
//purpose  : 
//=======================================================================
  void XIntTools_EdgeEdge::SetRange1(const Standard_Real aFirst,
...
//purpose  : 
//=======================================================================
  void XIntTools_EdgeEdge::SetRange2(const Standard_Real aFirst,
				    const Standard_Real aLast) 
{
...
//purpose  : 
//=======================================================================
  void XIntTools_EdgeEdge::SetRange1(const XIntTools_Range& aRange) 
{
...
//purpose  : 
//=======================================================================
  void XIntTools_EdgeEdge::SetRange2(const XIntTools_Range& aRange) 
{
...
//purpose  : 
//=======================================================================
  Standard_Boolean XIntTools_EdgeEdge::Order()const 
{
  return myOrder;
} 
//=======================================================================
...
//purpose  : 
//=======================================================================
  Standard_Boolean XIntTools_EdgeEdge::IsDone()const 
{
  return myIsDone;
} 
//=======================================================================
...
//purpose  : 
//=======================================================================
  Standard_Integer XIntTools_EdgeEdge::ErrorStatus()const 
{
...
//purpose  : 
//=======================================================================
  const XIntTools_SequenceOfCommonPrts& XIntTools_EdgeEdge::CommonParts() const 
{
...
//purpose  : 
//=======================================================================
  const XIntTools_Range&  XIntTools_EdgeEdge::Range1() const
{
  return myRange1;
} 
//=======================================================================
...
//purpose  : 
//=======================================================================
  const XIntTools_Range&  XIntTools_EdgeEdge::Range2() const
{
  return myRange2;
}
//=======================================================================
...
//purpose  : 
//=======================================================================
  void XIntTools_EdgeEdge::Perform() 
{
  ...
  //
  XIntTools_BeanBeanIntersector anIntersector(myCFrom, myCTo, myTolFrom, myTolTo);
  ...
  //
  const XIntTools_SequenceOfRanges& aSR=anIntersector.Result();
  aNbRange=aSR.Length();
  for(i=1; i <=aNbRange; ++i) {
    const XIntTools_Range& aRange =aSR.Value(i);
    aT1=aRange.First();
    aT2=aRange.Last();
    //
    if(IsProjectable(XIntTools_Tools::IntermediatePoint(aT1, aT2))) {
  ...
  for (i=1; i<=aNbCommonPrts; ++i) {
    XIntTools_CommonPrt& aCmnPrt=mySeqOfCommonPrts.ChangeValue(i);
  ...
  if ((aCTFrom==GeomAbs_Line   && aCTTo==GeomAbs_Circle) || 
	...
	if (bIsTouch) {
	  ...
	  XIntTools_Range& aRange2=(aCP.ChangeRanges2()).ChangeValue(1);
...
//purpose  : 
//=======================================================================
  void XIntTools_EdgeEdge::CheckData()
{
...
//purpose  : 
//=======================================================================
  void XIntTools_EdgeEdge::Prepare() 
{
...
//purpose  : 
//=======================================================================
  Standard_Integer XIntTools_EdgeEdge::IsProjectable(const Standard_Real t) const
{ 
...
//purpose  : 
//=======================================================================
  Standard_Real XIntTools_EdgeEdge::DistanceFunction(const Standard_Real t)//const
{
...
//purpose  : 
//=======================================================================
  Standard_Real XIntTools_EdgeEdge::DerivativeFunction(const Standard_Real t2)
{
...
//purpose  : [private]
//=======================================================================
  Standard_Real XIntTools_EdgeEdge::FindSimpleRoot (const Standard_Integer IP,
...
//purpose  : 
//=======================================================================
Standard_Integer XIntTools_EdgeEdge::FindRangeOnCurve2(XIntTools_CommonPrt&  aCommonPrt)
{
...
//purpose  : 
//=======================================================================
  void XIntTools_EdgeEdge::IsIntersection (const Standard_Real ta, 
					  const Standard_Real tb) 
{
  ...
  pri=XIntTools::PrepareArgs (myCFrom, tb, ta, myDiscret, myDeflection, anArgs);
  aNb=anArgs.Length();
...
//purpose  : 
//=======================================================================
  void XIntTools_EdgeEdge::FindDerivativeRoot(const XIntTools_CArray1OfReal& t,
...
//purpose  : 
//=======================================================================
  Standard_Integer XIntTools_EdgeEdge::GetParameterOnCurve2(const Standard_Real aT1, 
...
//purpose  : 
//=======================================================================
  Standard_Integer XIntTools_EdgeEdge::TreatVertexType(const Standard_Real am1,
						      ...
						      XIntTools_CommonPrt&  aCommonPrt) 
{
  ...
  ip=XIntTools::Parameter (aP, aCurveTo, tf2);
  if (ip){
    return ip;
  }
  // 
  ...
  // right point
  aP.SetXYZ(aPm2.XYZ()+aVm2.XYZ()*aL2);
  ip=XIntTools::Parameter (aP, aCurveTo, tl2);
  if (ip){
    return ip;
  }
  ...
  ip=XIntTools::Parameter (aP, aCurveFrom, tf1);
  if (ip){
    return ip;
  }
  ...
  // right point
  aP.SetXYZ(aPm1.XYZ()+aVm1.XYZ()*aL1);
  ip=XIntTools::Parameter (aP, aCurveFrom, tl1);
  if (ip){
    return ip;
  }
...
//=======================================================================
  Standard_Boolean XIntTools_EdgeEdge::CheckTouchVertex (const XIntTools_CommonPrt& aCP,
							Standard_Real& aTx1,
...
//purpose  : 
//=======================================================================
  Standard_Boolean XIntTools_EdgeEdge::CheckTouch(const XIntTools_CommonPrt& aCP,
						 Standard_Real& aTx1,
						 Standard_Real& aTx2) 
{
...
//purpose  : 
//=======================================================================
  void XIntTools_EdgeEdge::ComputeLineLine()
{
