...
#include <XIntTools_BeanBeanIntersector.ixx>
...
static 
  void LocalPrepareArgs(BRepAdaptor_Curve& theCurve,
			...
			XIntTools_CArray1OfReal&  theArgs);
...
// ==================================================================================
// function: XIntTools_BeanBeanIntersector
// purpose: 
// ==================================================================================
XIntTools_BeanBeanIntersector::XIntTools_BeanBeanIntersector() :
...
// purpose: 
// ==================================================================================
XIntTools_BeanBeanIntersector::XIntTools_BeanBeanIntersector(const TopoDS_Edge& theEdge1,
...
// purpose: 
// ==================================================================================
XIntTools_BeanBeanIntersector::XIntTools_BeanBeanIntersector(const BRepAdaptor_Curve& theCurve1,
...
// purpose: 
// ==================================================================================
void XIntTools_BeanBeanIntersector::Init(const TopoDS_Edge& theEdge1,
					const TopoDS_Edge& theEdge2) 
{
...
// purpose: 
// ==================================================================================
void XIntTools_BeanBeanIntersector::Init(const BRepAdaptor_Curve& theCurve1,
					const BRepAdaptor_Curve& theCurve2,
					const Standard_Real      theBeanTolerance1,
					const Standard_Real      theBeanTolerance2) 
{
...
// purpose: 
// ==================================================================================
void XIntTools_BeanBeanIntersector::SetBeanParameters(const Standard_Boolean IsFirstBean,
...
// purpose: 
// ==================================================================================
const XIntTools_SequenceOfRanges& XIntTools_BeanBeanIntersector::Result() const
{
  return myResults;
}
...
// purpose: 
// ==================================================================================
 void XIntTools_BeanBeanIntersector::Result(XIntTools_SequenceOfRanges& theResults) const
{
...
// purpose: 
// ==================================================================================
void XIntTools_BeanBeanIntersector::Perform() 
{
  ...
  XIntTools_Range aRange2, aRange;
  // 
  myIsDone = Standard_False;
  myResults.Clear();
  //
...
// purpose: 
// ==================================================================================
Standard_Boolean XIntTools_BeanBeanIntersector::FastComputeIntersection() 
{
...
// purpose: 
// ==================================================================================
Standard_Real XIntTools_BeanBeanIntersector::Distance(const Standard_Real theArg,
...
// purpose: 
// ==================================================================================
void XIntTools_BeanBeanIntersector::ComputeRoughIntersection() 
{
  ...
  XIntTools_CArray1OfReal anArgs;
  ...
  aNbRanges=myRangeManager.Length();
  for(i = 1; i <= aNbRanges; ++i) {
    const XIntTools_Range& aRange = myRangeManager.Range(i);
    aT2=aRange.Last();
...
// purpose: 
// ==================================================================================
void XIntTools_BeanBeanIntersector::ComputeUsingExtrema(const XIntTools_Range& theRange2) 
{
  //rln Dec 2008.
  ...
  for(Standard_Integer i = 1; i <= myRangeManager.Length(); i++) {
    ...
    if(myRangeManager.Flag(i) == 2 || myRangeManager.Flag(i) == 0) {
      const XIntTools_Range& aParamRange = myRangeManager.Range(i);
...
// purpose: 
// ==================================================================================
void XIntTools_BeanBeanIntersector::ComputeNearRangeBoundaries(const XIntTools_Range& theRange2) 
{
  ...
  if((myRangeManager.Flag(myRangeManager.Length()) == 3) || 
    ...
    const XIntTools_Range& aParamRange = myRangeManager.Range(myRangeManager.Length());
...
// purpose: 
// ==================================================================================
void XIntTools_BeanBeanIntersector::ComputeRangeFromStartPoint(const Standard_Boolean ToIncreaseParameter,
							      const Standard_Real    theParameter,
							      const Standard_Integer theIndex,
							      const Standard_Real    theParameter2,
							      const XIntTools_Range&  theRange2) 
{
...
static void LocalPrepareArgs(BRepAdaptor_Curve& theCurve,
  ...
  if(prepareargs) {
    XIntTools::PrepareArgs(theCurve, theLastParameter, theFirstParameter, aDiscretization, aRelativeDeflection, theArgs);
  }
}
// ---------------------------------------------------------------------------------
