...
#include <XIntTools_MarkedRangeSet.ixx>

XIntTools_MarkedRangeSet::XIntTools_MarkedRangeSet() :
myRangeNumber(0)
{
}

XIntTools_MarkedRangeSet::XIntTools_MarkedRangeSet(const Standard_Real    theFirstBoundary,
...
XIntTools_MarkedRangeSet::XIntTools_MarkedRangeSet(const XIntTools_CArray1OfReal& theSortedArray,
						 const Standard_Integer        theInitFlag)
...
void XIntTools_MarkedRangeSet::SetBoundaries(const Standard_Real    theFirstBoundary,
					    const Standard_Real    theLastBoundary,
					    const Standard_Integer theInitFlag) 
{
...
void XIntTools_MarkedRangeSet::SetRanges(const XIntTools_CArray1OfReal& theSortedArray,
					const Standard_Integer        theInitFlag) 
{
  myRangeSetStorer.Clear();
  myFlags.Clear();
...
Standard_Boolean XIntTools_MarkedRangeSet::InsertRange(const Standard_Real    theFirstBoundary,
						      const Standard_Real    theLastBoundary,
...
Standard_Boolean XIntTools_MarkedRangeSet::InsertRange(const XIntTools_Range&  theRange,
						      const Standard_Integer theFlag) 
{
...
void XIntTools_MarkedRangeSet::SetFlag(const Standard_Integer theIndex,
				      const Standard_Integer theFlag) 
{
  myFlags.SetValue(theIndex, theFlag);
}

Standard_Integer XIntTools_MarkedRangeSet::Flag(const Standard_Integer theIndex) const
{
  return myFlags(theIndex);
}

const TColStd_SequenceOfInteger& XIntTools_MarkedRangeSet::GetIndices(const Standard_Real theValue)
{
...
Standard_Integer XIntTools_MarkedRangeSet::GetIndex(const Standard_Real theValue) const
{
...
Standard_Integer XIntTools_MarkedRangeSet::GetIndex(const Standard_Real theValue,
...
XIntTools_Range XIntTools_MarkedRangeSet::Range(const Standard_Integer theIndex) const
{
  XIntTools_Range aRange(myRangeSetStorer(theIndex), myRangeSetStorer(theIndex+1));
  return aRange;
}
