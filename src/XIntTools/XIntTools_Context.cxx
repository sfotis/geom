...
//purpose  : 
//=======================================================================
XIntTools_Context::XIntTools_Context()
{
}
//=======================================================================
//function : ~
...
XIntTools_Context::~XIntTools_Context()
{
  ...
  //
  XIntTools_FClass2d* pFClass2d;
  aNb=myFClass2dMap.Extent();
  for (i=1; i<=aNb; ++i) {
    anAdr=myFClass2dMap(i);
    pFClass2d=(XIntTools_FClass2d*)anAdr;
    delete pFClass2d;
  }
  myFClass2dMap.Clear();
  //
  ...
  mySClassMap.Clear();
  //
  XIntTools_SurfaceRangeLocalizeData* pSData = NULL;
  aNb = myProjSDataMap.Extent();
  for (i=1; i<=aNb; ++i) {
    anAdr=myProjSDataMap(i);
    pSData = (XIntTools_SurfaceRangeLocalizeData*)anAdr;
    if(pSData)
      delete pSData;
    pSData = NULL;
  }
...
//purpose  : 
//=======================================================================
Geom2dHatch_Hatcher& XIntTools_Context::Hatcher(const TopoDS_Face& aF)
{
  Standard_Address anAdr;
  Geom2dHatch_Hatcher* pHatcher;
  //
...
//purpose  : 
//=======================================================================
XIntTools_FClass2d& XIntTools_Context::FClass2d(const TopoDS_Face& aF)
{
  Standard_Address anAdr;
  XIntTools_FClass2d* pFClass2d;
  //
  ...
  if (!anAdr) {
    ...
    //
    pFClass2d=new XIntTools_FClass2d(aFF, aTolF);
    //
    ...
    Standard_Address *pAdr=(Standard_Address *)anAdr;
    pFClass2d=(XIntTools_FClass2d*)*pAdr;
  }
...
//purpose  : 
//=======================================================================
GeomAPI_ProjectPointOnSurf& XIntTools_Context::ProjPS(const TopoDS_Face& aF)
{
  Standard_Address anAdr;
  GeomAPI_ProjectPointOnSurf* pProjPS;
  //
...
//purpose  : 
//=======================================================================
GeomAPI_ProjectPointOnCurve& XIntTools_Context::ProjPC(const TopoDS_Edge& aE)
{
  Standard_Address anAdr;
  GeomAPI_ProjectPointOnCurve* pProjPC;
  //
...
//purpose  : 
//=======================================================================
GeomAPI_ProjectPointOnCurve& XIntTools_Context::ProjPT(const Handle(Geom_Curve)& aC3D)
...
//purpose  : 
//=======================================================================
XIntTools_SurfaceRangeLocalizeData& XIntTools_Context::SurfaceData(const TopoDS_Face& aF) 
{
  Standard_Address anAdr;
  XIntTools_SurfaceRangeLocalizeData* pSData;
  //
  anAdr=myProjSDataMap.FindFromKey1(aF);
  if (!anAdr) {
    //
    pSData=new XIntTools_SurfaceRangeLocalizeData(3, 
						 3, 
    ...
    Standard_Address *pAdr=(Standard_Address *)anAdr;
    pSData=(XIntTools_SurfaceRangeLocalizeData*)*pAdr;
  }
  return *pSData;
...
//purpose  : 
//=======================================================================
BRepClass3d_SolidClassifier& XIntTools_Context::SolidClassifier(const TopoDS_Solid& aSolid)
{
  Standard_Address anAdr;
  BRepClass3d_SolidClassifier* pSC;
  //
...
//purpose  : 
//=======================================================================
Standard_Integer XIntTools_Context::ComputeVE(const TopoDS_Vertex& aV1, 
					     ...
					     Standard_Real& aT)
{
  ...
  Standard_Real aDist;
  //
  iFlag= XIntTools_Context::ComputeVE(aV1, aE2, aT, bToUpdate, aDist);
  //
  return iFlag;
}
//=======================================================================
...
//purpose  : 
//=======================================================================
Standard_Integer XIntTools_Context::ComputeVS(const TopoDS_Vertex& aV1, 
...
//purpose  : 
//=======================================================================
TopAbs_State XIntTools_Context::StatePointFace(const TopoDS_Face& aF,
					      const gp_Pnt2d& aP2d)
{
  TopAbs_State aState;
  XIntTools_FClass2d& aClass2d=FClass2d(aF);
...
//purpose  : 
//=======================================================================
Standard_Boolean XIntTools_Context::IsPointInFace(const TopoDS_Face& aF,
						 const gp_Pnt2d& aP2d)
{
...
//purpose  : 
//=======================================================================
Standard_Boolean XIntTools_Context::IsPointInOnFace(const TopoDS_Face& aF,
						   const gp_Pnt2d& aP2d)
{ 
  TopAbs_State aState=StatePointFace(aF, aP2d);
...
//purpose  : 
//=======================================================================
Standard_Boolean XIntTools_Context::IsValidPointForFace(const gp_Pnt& aP,
...
//purpose  : 
//=======================================================================
Standard_Boolean XIntTools_Context::IsValidPointForFaces (const gp_Pnt& aP,
...
//purpose  : 
//=======================================================================
Standard_Boolean XIntTools_Context::IsValidBlockForFace (const Standard_Real aT1,
							const Standard_Real aT2,
							const XIntTools_Curve& aC, 
							const TopoDS_Face& aF,
							const Standard_Real aTol) 
{
  Standard_Boolean bFlag;
  ...
  aTInterm=XIntTools_Tools::IntermediatePoint(aT1, aT2);
...
//purpose  : 
//=======================================================================
Standard_Boolean XIntTools_Context::IsValidBlockForFaces (const Standard_Real aT1,
							 const Standard_Real aT2,
							 const XIntTools_Curve& aC, 
							 const TopoDS_Face& aF1,
							 const TopoDS_Face& aF2,
							 const Standard_Real aTol) 
{
  ...
  if( !aPC1.IsNull() && !aPC2.IsNull() ) {
    Standard_Real aMidPar = XIntTools_Tools::IntermediatePoint(aT1, aT2);
    gp_Pnt2d aPnt2D;
...
//purpose  : 
//=======================================================================
Standard_Boolean XIntTools_Context::IsVertexOnLine (const TopoDS_Vertex& aV,
						   const XIntTools_Curve& aC, 
						   ...
						   Standard_Real& aT)
{
  ...
  bRet=XIntTools_Context::IsVertexOnLine(aV, aTolV, aC, aTolC , aT);
  //
  return bRet;
}
//=======================================================================
...
//purpose  : 
//=======================================================================
Standard_Boolean XIntTools_Context::ProjectPointOnEdge(const gp_Pnt& aP,
