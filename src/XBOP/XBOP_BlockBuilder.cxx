...
#include <XBOP_BlockBuilder.ixx>

#include <Standard_Failure.hxx>

//=======================================================================
//function : XBOP_BlockBuilder::XBOP_BlockBuilder
//purpose  : 
//=======================================================================
XBOP_BlockBuilder::XBOP_BlockBuilder()
:
...
//purpose  : 
//=======================================================================
  XBOP_BlockBuilder::XBOP_BlockBuilder (XBOP_ShapeSet& SS)
  :myIsDone(Standard_False)
{
  MakeBlock(SS);
}
...
//purpose  : 
//=======================================================================
  void XBOP_BlockBuilder::MakeBlock(XBOP_ShapeSet& SS)
{
...
//purpose  : 
//=======================================================================
  void XBOP_BlockBuilder::InitBlock()
{
  myBlockIndex = 1;
}
...
//purpose  : 
//=======================================================================
  Standard_Boolean XBOP_BlockBuilder::MoreBlock() const
{
...
//purpose  : 
//=======================================================================
  void XBOP_BlockBuilder::NextBlock()
{
  myBlockIndex++;
}
...
//purpose  : 
//=======================================================================
  XBOP_BlockIterator XBOP_BlockBuilder::BlockIterator() const
{
  ...
  return XBOP_BlockIterator(lower,upper);
}
...
//purpose  : 
//=======================================================================
  const TopoDS_Shape& XBOP_BlockBuilder::Element (const XBOP_BlockIterator& BI) const
{
...
//purpose  : 
//=======================================================================
  const TopoDS_Shape& XBOP_BlockBuilder::Element (const Standard_Integer index) const
{
...
//purpose  : 
//=======================================================================
  Standard_Integer XBOP_BlockBuilder::Element (const TopoDS_Shape& E) const
{
...
//purpose  : 
//=======================================================================
  Standard_Boolean XBOP_BlockBuilder::ElementIsValid (const XBOP_BlockIterator& BI) const 
{  
...
//purpose  : 
//=======================================================================
  Standard_Boolean XBOP_BlockBuilder::ElementIsValid (const Standard_Integer Sindex) const
{  
...
//purpose  : 
//=======================================================================
  Standard_Integer XBOP_BlockBuilder::AddElement(const TopoDS_Shape& S) 
{
...
//purpose  : 
//=======================================================================
  void XBOP_BlockBuilder::SetValid(const XBOP_BlockIterator& BI,
...
//purpose  : 
//=======================================================================
  void XBOP_BlockBuilder::SetValid(const Standard_Integer Sindex,
				  const Standard_Boolean isvalid)
{
...
//purpose  : 
//=======================================================================
  Standard_Boolean XBOP_BlockBuilder::CurrentBlockIsRegular()
{
