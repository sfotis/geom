...
//=======================================================================
//function : XBOP_WireEdgeSet::XBOP_WireEdgeSet
//purpose  : 
//=======================================================================
  XBOP_WireEdgeSet::XBOP_WireEdgeSet()
:
  XBOP_ShapeSet(TopAbs_VERTEX)
{
}
//=======================================================================
//function : XBOP_WireEdgeSet::XBOP_WireEdgeSet
//purpose  : 
//=======================================================================
  XBOP_WireEdgeSet::XBOP_WireEdgeSet(const TopoDS_Face& F)
: 
  XBOP_ShapeSet(TopAbs_VERTEX),
  myFace(F)
{
...
//purpose  : 
//=======================================================================
  void XBOP_WireEdgeSet::Initialize(const TopoDS_Face& F)
{
  myFace=F;
}
...
//purpose  : 
//=======================================================================
  void XBOP_WireEdgeSet::AddShape(const TopoDS_Shape& S)
{
  ProcessAddShape(S);
}
...
//purpose  : 
//=======================================================================
  void XBOP_WireEdgeSet::AddStartElement(const TopoDS_Shape& S)
{
...
//purpose  : 
//=======================================================================
  void XBOP_WireEdgeSet::AddElement(const TopoDS_Shape& S)
{
  XBOP_ShapeSet::AddElement(S);
}
...
//purpose  : 
//=======================================================================
  void  XBOP_WireEdgeSet::InitNeighbours(const TopoDS_Shape& E)
{
...
//purpose  : 
//=======================================================================
  void XBOP_WireEdgeSet::FindNeighbours()
{
...
//=======================================================================
  const TopTools_ListOfShape & XBOP_WireEdgeSet::MakeNeighboursList(const TopoDS_Shape& Earg,
								   const TopoDS_Shape& Varg)
{
  ...
  if (nclosing) { 
    ...
    if (newn >= 2 ) {
      ...
      XBOPTools_Tools2D::CurveOnSurface(E, F, PCE, fiE, laE, tolpc, Standard_False);
	...
	XBOPTools_Tools2D::CurveOnSurface (EE, F, PCEE, fiEE, laEE, tolpcc, Standard_False);//
	//
	if (!PCEE.IsNull()) {
...
//purpose  : 
//=======================================================================
  Standard_Boolean XBOP_WireEdgeSet::VertexConnectsEdges(const TopoDS_Shape& V,
							const TopoDS_Shape& E1,
							const TopoDS_Shape& E2,
							TopAbs_Orientation& o1,
...
//purpose  : 
//=======================================================================
  Standard_Boolean XBOP_WireEdgeSet::VertexConnectsEdgesClosing(const TopoDS_Shape& V, 
							       const TopoDS_Shape& E1, 
...
//purpose  : 
//=======================================================================
  Standard_Integer XBOP_WireEdgeSet::NbClosingShapes(const TopTools_ListOfShape & L) const
{
...
//purpose  : 
//=======================================================================
  void XBOP_WireEdgeSet::LocalD1(const TopoDS_Face&  F,
				const TopoDS_Edge&  E,
...
//purpose  : 
//=======================================================================
  Standard_Boolean XBOP_WireEdgeSet::IsClosed(const TopoDS_Shape& E) const
{
  ...
  if(closed) {
    TopoDS_Edge aE1, aE2;
    XBOPTools_Tools3D::GetSeam (myFace, aE1, aE2);
...
//purpose  : 
//=======================================================================
  void XBOP_WireEdgeSet::IsUVISO(const TopoDS_Edge& E,
				const TopoDS_Face& F,
				...
				Standard_Boolean& viso) 
{
  ...
  XBOPTools_Tools2D::CurveOnSurface (E, F, PC, fE, lE, tolpc, Standard_False);//
  
  if (PC.IsNull()) {
    Standard_ProgramError::Raise("XBOP_WireEdgeSet::IsUVISO");
  }
...
//purpose  : 
//=======================================================================
  Standard_Boolean XBOP_WireEdgeSet::IsUClosed(const TopoDS_Shape& E) const
{
  const TopoDS_Edge& EE = TopoDS::Edge(E);
...
//purpose  : 
//=======================================================================
  Standard_Boolean XBOP_WireEdgeSet::IsVClosed(const TopoDS_Shape& E) const
{
  const TopoDS_Edge& EE = TopoDS::Edge(E);
...
//purpose  : 
//=======================================================================
  const TopoDS_Face& XBOP_WireEdgeSet::Face() const 
{
  return myFace;
}
//=======================================================================
//function : XBOP_Tools::KeptTwice
//purpose  : 
//=======================================================================
  Standard_Boolean XBOP_WireEdgeSet::KeptTwice (const TopoDS_Edge& aSpEF2) const
...
//=======================================================================
//function : XBOP_Tools::RemoveEdgeFromWES
//purpose  : 
//=======================================================================
  void XBOP_WireEdgeSet::RemoveEdgeFromWES(const TopoDS_Edge& aSpEF2)
