...
#include <XBOP_SolidClassifier.ixx>
...
//purpose  : 
//=======================================================================
XBOP_SolidClassifier::XBOP_SolidClassifier()
{
  Clear();
}
...
//purpose  : 
//=======================================================================
  void XBOP_SolidClassifier::Clear() 
{
  myPClassifier = NULL;
...
//purpose  : 
//=======================================================================
  void XBOP_SolidClassifier::LoadSolid(const TopoDS_Solid& SOL) 
{
...
//purpose  : 
//=======================================================================
  TopAbs_State XBOP_SolidClassifier::Classify (const TopoDS_Solid& SOL, 
					      const gp_Pnt& P, 
...
//purpose  : 
//=======================================================================
  void XBOP_SolidClassifier::LoadShell(const TopoDS_Shell& SHE) 
{
  Standard_Boolean found;
...
//purpose  : 
//=======================================================================
  TopAbs_State XBOP_SolidClassifier::Classify (const TopoDS_Shell& SHE, 
					      const gp_Pnt& P,
					      const Standard_Real Tol)
{
  myPClassifier = NULL;
...
//purpose  : 
//=======================================================================
  TopAbs_State XBOP_SolidClassifier::State() const
{
  return myState;
}
...
//purpose  : 
//=======================================================================
  void XBOP_SolidClassifier::Destroy()
{
