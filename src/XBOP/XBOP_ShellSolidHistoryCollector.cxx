...
#include <XBOP_ShellSolidHistoryCollector.ixx>
...
// purpose:
// ====================================================================================================
XBOP_ShellSolidHistoryCollector::XBOP_ShellSolidHistoryCollector(const TopoDS_Shape& theShape1,
...
// purpose:
// ====================================================================================================
void XBOP_ShellSolidHistoryCollector::AddNewFace(const TopoDS_Shape&       theOldShape,
						...
						const XBOPTools_PDSFiller& theDSFiller) 
{
  ...
  const XBooleanOperations_IndexedDataMapOfShapeInteger& aMap = theDSFiller->DS().ShapeIndexMap(1);
...
// purpose:
// ====================================================================================================
void XBOP_ShellSolidHistoryCollector::SetResult(const TopoDS_Shape&       theResult,
					       const XBOPTools_PDSFiller& theDSFiller) 
{
  myResult = theResult;
...
// purpose:
// ====================================================================================================
void XBOP_ShellSolidHistoryCollector::FillSection(const XBOPTools_PDSFiller& theDSFiller) 
{
  ...
  for(i = 1; i <= aFFs.Extent(); i++) {
    ...
    XBOPTools_SequenceOfCurves& aSeqOfCurves = aFF.Curves();
    Standard_Integer j = 0;

    for(j = 1; j <= aSeqOfCurves.Length(); j++) {
      const XBOPTools_Curve& aCurve = aSeqOfCurves.Value(j);

      const XBOPTools_ListOfPaveBlock& aPBList = aCurve.NewPaveBlocks();
      XBOPTools_ListIteratorOfListOfPaveBlock anIt(aPBList);
    ...
    // Old Section Edges
    const XBOPTools_ListOfPaveBlock& aSectList = aFF.PaveBlocks();
...
// purpose:  
// ====================================================================================================
void XBOP_ShellSolidHistoryCollector::FillEdgeHistory(const XBOPTools_PDSFiller& theDSFiller) 
{
