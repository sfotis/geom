...
// purpose: 
//=======================================================================
  void XBOP_Draw::DrawListOfShape (const TopTools_ListOfShape& aListOfShape,
...
// purpose: 
//=======================================================================
  void XBOP_Draw::DrawListOfEdgesWithPC (const TopoDS_Face& aFace,
				  ...
				  
{
  ...
  TopTools_ListIteratorOfListOfShape anIt(aListOfShape);
    ...
    aN=aNm+jIndex;
    Standard_CString aTxt=aN.ToCString();
    XBOP_Draw::DrawEdgeWithPC(aFace, aEx, aTxt);
    cout << " " << aTxt << flush;
  }
...
// purpose: 
//=======================================================================
  void XBOP_Draw::DrawEdgeWithPC (const TopoDS_Face& aFace,
...
void XBOP_Draw::DrawListOfShape       (const TopTools_ListOfShape& , 
				      const Standard_CString ){}
void XBOP_Draw::DrawListOfEdgesWithPC (const TopoDS_Face& ,
...
void XBOP_Draw::DrawListOfEdgesWithPC (const TopoDS_Face& ,
				      const TopTools_ListOfShape& ,
				      const Standard_CString ){}
void XBOP_Draw::DrawEdgeWithPC        (const TopoDS_Face& ,
				      const TopoDS_Edge& ,
				      const Standard_CString ){} 
void XBOP_Draw::Wait(){}
