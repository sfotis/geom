...
#include <XBOP_WireEdgeClassifier.hxx>
...
//=======================================================================
//function : XBOP_FaceBuilder
//purpose  : 
//=======================================================================
XBOP_FaceBuilder::XBOP_FaceBuilder():
  myTreatment(0),
...
//purpose  : 
//=======================================================================
void XBOP_FaceBuilder::SetContext(const Handle(XIntTools_Context)& aCtx)
{
  myContext=aCtx;
}
//=======================================================================
...
//purpose  : 
//=======================================================================
const Handle(XIntTools_Context)& XBOP_FaceBuilder::Context()const
{
  return myContext;
}
//=======================================================================
...
//purpose  : 
//=======================================================================
void XBOP_FaceBuilder::SetTreatment(const Standard_Integer aTreatment)
{
...
//purpose  : 
//=======================================================================
Standard_Integer XBOP_FaceBuilder::Treatment()const 
{
  return myTreatment;
}
//=======================================================================
...
//purpose  : 
//=======================================================================
void XBOP_FaceBuilder::SetTreatSDScales(const Standard_Integer aTreatment)
{
...
//purpose  : 
//=======================================================================
Standard_Integer XBOP_FaceBuilder::TreatSDScales()const 
{
...
//purpose  : 
//=======================================================================
const XBOP_WireEdgeSet& XBOP_FaceBuilder::WES() const
{
  return *myWES;
}
//=======================================================================
...
//purpose  : 
//=======================================================================
const TopTools_ListOfShape& XBOP_FaceBuilder::NewFaces() const
{
  return myNewFaces;
}
//=======================================================================
...
//purpose  : 
//=======================================================================
void XBOP_FaceBuilder::Do(const XBOP_WireEdgeSet& aWES,
			 const Standard_Boolean bForceClass) 
{
  myFace=aWES.Face();
  myWES=(XBOP_WireEdgeSet*) &aWES;
  //
  if (myContext.IsNull()) {
    myContext=new XIntTools_Context;
  }
  //
  XBOP_WESCorrector aWESCor;
  aWESCor.SetWES(aWES);
  aWESCor.Do();
  XBOP_WireEdgeSet& aNewWES=aWESCor.NewWES();
  // 
...
//purpose  : 
//=======================================================================
void XBOP_FaceBuilder::DoInternalEdges()
{
  ...
  for (i=1; i<=aNbE; i++) {
    ...
    bHasCurveOnSurface=
      XBOPTools_Tools2D::HasCurveOnSurface(aE, myFace, aC2D, aT1, aT2, aToler);
  ...
  for (i=1; i<=aNbF; i++) {
    ...
    XBOP_BuilderTools::MakeConnexityBlocks(aLE, TopAbs_EDGE, aLConBlks);

    XBOP_ListIteratorOfListOfConnexityBlock aConBlkIt(aLConBlks);
    for (; aConBlkIt.More(); aConBlkIt.Next()) {
      XBOP_ConnexityBlock& aConnexityBlock=aConBlkIt.Value();
...
// purpose :  
//=======================================================================
void XBOP_FaceBuilder::SDScales()
{
  ...
  XBOP_ListIteratorOfListOfConnexityBlock aLCBIt;
  //
  XBOP_BuilderTools::MakeConnexityBlocks (myNewFaces, TopAbs_FACE, aLCB);
  //
...
//purpose  : 
//=======================================================================
void XBOP_FaceBuilder::PerformAreas(XBOP_WireEdgeSet& aWES)
{
  ...
  for ( ; aIt1.More(); aIt1.Next()) {
    ...
    bIsValidIn2D=XBOPTools_Tools3D::IsValidArea (aFx, bNegativeFlag);
    if(bIsValidIn2D) {
