...
#include <XBOP_Area2dBuilder.ixx>

#include <XBOP_Loop.hxx>
#include <XBOP_ListIteratorOfListOfLoop.hxx>

//=======================================================================
//function : XBOP_Area2dBuilder::XBOP_Area2dBuilder
//purpose  : 
//=======================================================================
XBOP_Area2dBuilder::XBOP_Area2dBuilder()
{
}
...
//purpose  : 
//=======================================================================
  XBOP_Area2dBuilder::XBOP_Area2dBuilder(XBOP_LoopSet& LS, 
...
//purpose  : 
//=======================================================================
  void XBOP_Area2dBuilder::InitAreaBuilder(XBOP_LoopSet&        LS,
					  XBOP_LoopClassifier& LC,
					  const Standard_Boolean ForceClass)
{
  TopAbs_State     state;
  ...
  for (LS.InitLoop(); LS.MoreLoop(); LS.NextLoop()) {
	...
	ADD_Loop_TO_LISTOFLoop(L, newArea0);
	  ...
	  const Handle(XBOP_Loop)& lb = LoopIter.Value();
