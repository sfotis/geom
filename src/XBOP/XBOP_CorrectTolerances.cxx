...
#include <XBOP_CorrectTolerances.ixx>
...
// purpose : 
//=======================================================================
  void XBOP_CorrectTolerances::CorrectTolerances(const TopoDS_Shape& aShape,
						const Standard_Real aMaxTol)
{
  XBOP_CorrectTolerances::CorrectPointOnCurve(aShape, aMaxTol);
  XBOP_CorrectTolerances::CorrectCurveOnSurface(aShape, aMaxTol);
}
...
// purpose : 
//=======================================================================
  void XBOP_CorrectTolerances::CorrectPointOnCurve(const TopoDS_Shape& S,
						  const Standard_Real aMaxTol)
{
...
// purpose : 
//=======================================================================
  void XBOP_CorrectTolerances::CorrectCurveOnSurface(const TopoDS_Shape& S,
						    const Standard_Real aMaxTol)
{
