...
#include <XBooleanOperations_AncestorsAndSuccessors.ixx>
#include <XBooleanOperations_AncestorsSeqAndSuccessorsSeq.hxx>

//===========================================================================
//function : XBooleanOperations_AncestorsAndSuccessors
//purpose  : default creator
//===========================================================================
XBooleanOperations_AncestorsAndSuccessors::XBooleanOperations_AncestorsAndSuccessors():
 myAncestors(0L),
 mySuccessors(0L),
 myOrientations(0L),
 myAncestorsSize(0),
...
//purpose  : destructor
//===========================================================================
  void XBooleanOperations_AncestorsAndSuccessors::Destroy()
{
  if (myAncestors) {
...
//purpose  : 
//===========================================================================
  void XBooleanOperations_AncestorsAndSuccessors::Dump() const
{
  Standard_Integer i;
