...
#include <XBooleanOperations_Explorer.ixx>

const static Standard_Integer theStackSize=20;
//
//===========================================================================
//function : XBooleanOperations_Explorer
//purpose  : 
//===========================================================================
  XBooleanOperations_Explorer::XBooleanOperations_Explorer
    (const XBooleanOperations_ShapesDataStructure& SDS):
  myStack(0L),
  myTopOfStack(-1),
  mySizeOfStack(-1),
...
{
  myShapesDataStructure = (XBooleanOperations_PShapesDataStructure)&SDS;
}
//===========================================================================
//function : Delete
//purpose  : ~XBooleanOperations_Explorer
//===========================================================================
  void XBooleanOperations_Explorer::Delete()
{
  if(myStack != 0L) {
...
//purpose  : 
//===========================================================================
  void XBooleanOperations_Explorer::Init(const Standard_Integer aShapeNumber,
...
//purpose  : 
//===========================================================================
  Standard_Integer XBooleanOperations_Explorer::Current()
{
  myTopOfStack--;
  if (myTopOfStack < 0)
    hasMore = Standard_False;
...
//purpose  : 
//===========================================================================
  void XBooleanOperations_Explorer::Next()
{
  TopAbs_ShapeEnum theTypeOfShapeOnTop,successorType;
...
//purpose  : 
//===========================================================================
  Standard_Boolean XBooleanOperations_Explorer::More() const
{
  return hasMore;
}
...
//purpose  : 
//===========================================================================
  void XBooleanOperations_Explorer::Dump(Standard_OStream& S) const
{
  Standard_Integer i;
  Standard_Integer* theSuccessors;

  theSuccessors = ((Standard_Integer*)myStack);
  S  << "\n" << "Dump of XBooleanOperations_Explorer:" << "\n";
