...
#include <XBooleanOperations_ShapesDataStructure.ixx>
...
//===========================================================================
//function : XBooleanOperations_ShapesDataStructure
//purpose  : creator
//===========================================================================
  XBooleanOperations_ShapesDataStructure::XBooleanOperations_ShapesDataStructure():
  ...
  myNbEdges(0)
{
  //printf("-XBOPDS_ShapesDataStructure CREATE:%x\n", (int)this);
}
//===========================================================================
//function : XBooleanOperations_ShapesDataStructure
//purpose  : creator
//===========================================================================
  XBooleanOperations_ShapesDataStructure::XBooleanOperations_ShapesDataStructure(const TopoDS_Shape& Object,
  ...
  myNbEdges(0)
{
  ...
  XBooleanOperations_IndexedDataMapOfShapeAncestorsSuccessors IndDatMapTool;
  XBooleanOperations_IndexedDataMapOfShapeAncestorsSuccessors IndDatMapObject;
  ...
  for (i=1; i<=myNumberOfShapesOfTheObject; i++){
    const XBooleanOperations_AncestorsSeqAndSuccessorsSeq& theAncestorsSeqAndSuccessorsSeq =
...
//===========================================================================
  XBooleanOperations_ShapesDataStructure::~XBooleanOperations_ShapesDataStructure()
{
  //printf(" XBOPDS_ShapesDataStructure DELETE:%x\n", (int)this);
  Destroy();
}
...
//purpose  : destructor
//===========================================================================
  void XBooleanOperations_ShapesDataStructure::Destroy()
{
  Standard_Integer i;

  for (i=0;i<myNumberOfInsertedShapes;i++) {
    myListOfShapeAndInterferences[i].~XBooleanOperations_ShapeAndInterferences();
  }
...
//purpose  : 
//===========================================================================
  const XBooleanOperations_IndexedDataMapOfShapeInteger& 
    XBooleanOperations_ShapesDataStructure::ShapeIndexMap(const Standard_Integer iRank)const
{
  if (iRank == 1)
...
//purpose  : 
//===========================================================================
  Standard_Integer XBooleanOperations_ShapesDataStructure::ShapeIndex(const TopoDS_Shape& aS,
								     const Standard_Integer iRank) const
{
  Standard_Integer anIndex=0;
  const XBooleanOperations_IndexedDataMapOfShapeInteger& aMap=ShapeIndexMap(iRank);
  if (aMap.Contains(aS)) {
...
//purpose  : 
//===========================================================================
  void XBooleanOperations_ShapesDataStructure::FillIndexedMapOfShapesAncestorsAndSuccessors
  (const TopoDS_Shape& Sha,
   XBooleanOperations_IndexedDataMapOfShapeAncestorsSuccessors& IndDatMap) const
{
  Standard_Integer TotalNumberOfShapes = 1;
  XBooleanOperations_AncestorsSeqAndSuccessorsSeq theAncestorAndSuccessor;
  ...
  for(Standard_Integer i=1; i <= aNumberOfShapes; i++) {
    const XBooleanOperations_AncestorsSeqAndSuccessorsSeq& anAncestorAndSuccessorSeq1=IndDatMap(i);
	...
	XBooleanOperations_AncestorsSeqAndSuccessorsSeq& anAncestorAndSuccessorSeq2 = 
...
//purpose  : 
//===========================================================================
  void XBooleanOperations_ShapesDataStructure::FindSubshapes
  (const TopoDS_Shape& Sha,
...
// 
  ...
  XBooleanOperations_AncestorsSeqAndSuccessorsSeq& AncSucOfShape=IndDatMap.ChangeFromIndex(anIndexOfShape);
  for(; anIt.More(); anIt.Next()) {
    ...
    if(!IndDatMap.Contains(aSubShape)) {
      ...
      XBooleanOperations_AncestorsSeqAndSuccessorsSeq anAncestorAndSuccessorSeq;
...
//purpose  : 
//===========================================================================
  void XBooleanOperations_ShapesDataStructure::ReInit() 
{
  Standard_Integer i,NewLength;
  XBooleanOperations_PShapeAndInterferences NewListOfShapeAndInterferences;

  NewLength = AddedValue + myLength;
  NewListOfShapeAndInterferences = (XBooleanOperations_PShapeAndInterferences)
    Standard::Allocate(NewLength*sizeof(XBooleanOperations_ShapeAndInterferences));
  ...
  for (i=0;i<myNumberOfInsertedShapes;i++)    {
    new (&NewListOfShapeAndInterferences[i])
      XBooleanOperations_ShapeAndInterferences(myListOfShapeAndInterferences[i]);
...
//purpose  : 
//===========================================================================
void XBooleanOperations_ShapesDataStructure::InsertShapeAndAncestorsSuccessors
  (const TopoDS_Shape& S,
   const XBooleanOperations_AncestorsSeqAndSuccessorsSeq& AncSuc,
   const Standard_Integer shift)
{
  ...
  new (&(myListOfShapeAndInterferences[myNumberOfInsertedShapes].myAncestorsAndSuccessors)) 
    XBooleanOperations_AncestorsAndSuccessors(AncSuc,shift);

  myListOfShapeAndInterferences[myNumberOfInsertedShapes].myState = XBooleanOperations_UNKNOWN;
...
//purpose  : 
//===========================================================================
  const TopoDS_Shape& XBooleanOperations_ShapesDataStructure::GetShape(const Standard_Integer index) const
{
...
//purpose  : 
//===========================================================================
  const TopoDS_Shape& XBooleanOperations_ShapesDataStructure::Shape(const Standard_Integer index) const
{
...
//purpose  : 
//===========================================================================
  TopAbs_ShapeEnum XBooleanOperations_ShapesDataStructure::GetShapeType(const Standard_Integer index) const
{
  if ((index<1)||(index>myNumberOfInsertedShapes))    {
    Message(1);
  }
...
//purpose  : 
//===========================================================================
  const Bnd_Box& XBooleanOperations_ShapesDataStructure::GetBoundingBox(const Standard_Integer index) const
{
  if ((index<1)||(index>myNumberOfInsertedShapes))    {
    Message(1);
  }
...
//purpose  : 
//===========================================================================
  XBooleanOperations_StateOfShape XBooleanOperations_ShapesDataStructure::GetState(const Standard_Integer index) const
{
  if ((index<1)||(index>myNumberOfInsertedShapes))    {
    Message(1);
  }
...
//purpose  : 
//===========================================================================
  void XBooleanOperations_ShapesDataStructure::SetState(const Standard_Integer index,
						       const XBooleanOperations_StateOfShape theState) 
{
  if ((index<1)||(index>myNumberOfInsertedShapes)) {
    Message(1);
  }
...
//===========================================================================
  Standard_Integer 
    XBooleanOperations_ShapesDataStructure::NumberOfAncestors(const Standard_Integer index) const
{
  if ((index<1)||(index>myNumberOfInsertedShapes))  {
    Message(1);
  }
...
//===========================================================================
  Standard_Integer 
    XBooleanOperations_ShapesDataStructure::NumberOfSuccessors(const Standard_Integer index) const
{
  if ((index<1)||(index>myNumberOfInsertedShapes))    {
    Message(1);
  }
...
//===========================================================================
 Standard_Integer 
  XBooleanOperations_ShapesDataStructure::GetAncestor(const Standard_Integer index,
...
//===========================================================================
  Standard_Integer 
    XBooleanOperations_ShapesDataStructure::GetSuccessor(const Standard_Integer index,
...
//===========================================================================
 void 
   XBooleanOperations_ShapesDataStructure::GetAncestors(const Standard_Integer index,
...
//===========================================================================
  void 
    XBooleanOperations_ShapesDataStructure::GetSuccessors(const Standard_Integer index,
...
//purpose  : 
//===========================================================================
  Standard_Integer XBooleanOperations_ShapesDataStructure::NumberOfShapesOfTheObject()const
{
...
//purpose  : 
//===========================================================================
  Standard_Integer XBooleanOperations_ShapesDataStructure::NumberOfShapesOfTheTool()const
{
...
//purpose  : 
//===========================================================================
  Standard_Integer XBooleanOperations_ShapesDataStructure::NumberOfInsertedShapes()const
{
...
//purpose  : 
//===========================================================================
  Standard_Integer XBooleanOperations_ShapesDataStructure::NumberOfNewShapes()const
{
...
//purpose  : 
//===========================================================================
  Standard_Integer XBooleanOperations_ShapesDataStructure::NumberOfSourceShapes()const
{
  Standard_Integer aNb;
...
//===========================================================================
  Standard_Boolean 
    XBooleanOperations_ShapesDataStructure::IsNewShape(const Standard_Integer anIndex)const
{
...
//purpose  : 
//===========================================================================
  const  XBooleanOperations_ShapeAndInterferences& 
    XBooleanOperations_ShapesDataStructure::Line(const Standard_Integer index) const
{
  if ((index<1)||(index>myNumberOfInsertedShapes)) {
    Message(1);
  }
...
//purpose  : 
//===========================================================================
  const TopoDS_Shape& XBooleanOperations_ShapesDataStructure::Object()const 
{
  return myObject;
}
//===========================================================================
...
//purpose  : 
//===========================================================================
  const TopoDS_Shape& XBooleanOperations_ShapesDataStructure::Tool()const 
{
  return myTool;
}
//===========================================================================
...
//purpose  : 
//===========================================================================
  void XBooleanOperations_ShapesDataStructure::ObjectRange(Standard_Integer& iFirst,
...
//purpose  : 
//===========================================================================
  void XBooleanOperations_ShapesDataStructure::ToolRange(Standard_Integer& iFirst,
							Standard_Integer& iLast)const 
{
...
//purpose  : 
//===========================================================================
  Standard_Integer XBooleanOperations_ShapesDataStructure::Rank(const Standard_Integer nS)const
...
//===========================================================================
  Standard_Integer 
    XBooleanOperations_ShapesDataStructure::RefEdge(const Standard_Integer anIndex)const
{
...
//purpose  : 
//===========================================================================
  Standard_Integer XBooleanOperations_ShapesDataStructure::NbEdges()const 
{
  return myNbEdges;
}
...
{
  char buf[256];
  sprintf(buf, " XBooleanOperations_ShapesDataStructure:: ");
...
//purpose  : 
//===========================================================================
  void XBooleanOperations_ShapesDataStructure::Dump(Standard_OStream& S) const
{
  
  Standard_Integer i,j;
  TopAbs_ShapeEnum T;
  //ZZ gp_Pnt thePoint;
  XBooleanOperations_StateOfShape St;

  S<<endl<<"XBooleanOperations_ShapesDataStructure::Dump()"<<endl;
  ...
  for (i=1;i<=myNumberOfInsertedShapes;i++)
	...
	case TopAbs_SHAPE :
      ...
      switch(St)
	{
	case XBooleanOperations_IN :
	  S << "IN          ";
	  break;
	  
	case XBooleanOperations_OUT :
	  S << "OUT         ";
	  break;
	  
	case XBooleanOperations_UNKNOWN :
	  S << "UNKNOWN     ";
	  break;
	  
	case XBooleanOperations_ON :
	  S << "ON          ";
	  break;
	  
	case XBooleanOperations_INOROUT :
	  S << "INOROUT     ";
	  break;
	  
	case XBooleanOperations_INTERSECTED :
	  S << "INTERSECTED ";
	  break;
...
//purpose  : 
//===========================================================================
  void XBooleanOperations_ShapesDataStructure::LightDump(Standard_OStream& S) const
{
  Standard_Real a,b,c,d,e,f;
  Standard_Integer i;
  TopAbs_ShapeEnum T;
...
//===========================================================================
  TopAbs_Orientation 
    XBooleanOperations_ShapesDataStructure::GetOrientation(const Standard_Integer index,
							  const Standard_Integer successorNumber) const
{
  if ((index<1)||(index>myNumberOfInsertedShapes)||(successorNumber<1)||(successorNumber>NumberOfSuccessors(index)))  {
    Message(1);
...
//===========================================================================
 void 
   XBooleanOperations_ShapesDataStructure::GetOrientations(const Standard_Integer index,
...
//purpose  : 
//===========================================================================
  void XBooleanOperations_ShapesDataStructure::InsertInterference(const Standard_Integer index,
								 const XBooleanOperations_InterferenceResult&)// IR) 
{
  if ((index<1)||(index>myNumberOfInsertedShapes))    {
    Message(1);
  }
...
//purpose  : 
//===========================================================================
  const XBooleanOperations_InterferenceResult& 
    XBooleanOperations_ShapesDataStructure::GetInterference(const Standard_Integer index,
							   const Standard_Integer interfNumber) const
{
  ...
  static XBooleanOperations_InterferenceResult aIR;
  return aIR;
...
//===========================================================================
  Standard_Integer 
    XBooleanOperations_ShapesDataStructure::GetIntersectedShape(const Standard_Integer index,
							       const Standard_Integer interfNumber) const
{
  if ((index<1)||(index>myNumberOfInsertedShapes))    {
    Message(1);
...
//===========================================================================
  Standard_Integer 
    XBooleanOperations_ShapesDataStructure::GetIntersectionResult (const Standard_Integer index,
								  const Standard_Integer interfNumber) const
{
  if ((index<1)||(index>myNumberOfInsertedShapes))    {
    Message(1);
...
//===========================================================================
 Standard_Integer 
    XBooleanOperations_ShapesDataStructure::NumberOfInterferences(const Standard_Integer index) const
{
  if ((index<1)||(index>myNumberOfInsertedShapes))    {
    Message(1);
  }
