...
#include <XBooleanOperations_ShapeAndInterferences.ixx>

//===========================================================================
//function : ShapeAndInterferences
//purpose  : 
//===========================================================================
XBooleanOperations_ShapeAndInterferences::XBooleanOperations_ShapeAndInterferences():
    myState(XBooleanOperations_UNKNOWN)
{
}
...
//purpose  : 
//===========================================================================
  void XBooleanOperations_ShapeAndInterferences::SetInterference
    (const XBooleanOperations_InterferenceResult& Interf) 
{
...
//purpose  : 
//===========================================================================
  void XBooleanOperations_ShapeAndInterferences::Dump() const
{
