...
#include <XBooleanOperations_OnceExplorer.ixx>
...
//===========================================================================
//function : XBooleanOperations_OnceExplorer
//purpose  : 
//===========================================================================
  XBooleanOperations_OnceExplorer::XBooleanOperations_OnceExplorer
    (const  XBooleanOperations_ShapesDataStructure& SDS):
  XBooleanOperations_Explorer(SDS)
{
...
//===========================================================================
//function : Delete
//purpose  : alias ~XBooleanOperations_Explorer
//===========================================================================
  void XBooleanOperations_OnceExplorer::Delete()
{
  if (myArrayOfBits) {
    free (myArrayOfBits);
  }
  XBooleanOperations_Explorer::Delete();
}
...
//purpose  : 
//===========================================================================
  void XBooleanOperations_OnceExplorer::Init(const Standard_Integer aShapeNumber,
...
//purpose  : 
//===========================================================================
  Standard_Integer XBooleanOperations_OnceExplorer::Current()
{
  myTopOfStack--;
  if (myTopOfStack < 0)
    hasMore = Standard_False;
...
//purpose  : 
//===========================================================================
  void XBooleanOperations_OnceExplorer::Next()
{
  TopAbs_ShapeEnum theTypeOfShapeOnTop,successorType;
...
//purpose  : 
//===========================================================================
  void XBooleanOperations_OnceExplorer::Dump(Standard_OStream& S) const
{
  Standard_Integer u;
  Standard_Integer* anArrayOfBits;
